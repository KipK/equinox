...
var He = 1e4, Ue = class extends Error {
	...
	cause;
	constructor(e, t) {
		super(e.missing.length > 0 ? `Unable to load Home Assistant components: ${e.missing.join(", ")}` : "Unable to load Home Assistant components"), this.name = "HaComponentsLoadError", this.result = qe(e), this.cause = t;
	}
}, We = [
	"ha-form",
	"ha-icon",
...
function Ze(e, t, n) {
	let r, i = Promise.resolve(e).catch((e) => {
		throw Xe(`Failed while ${n}`, e);
	}), a = new Promise((e, i) => {
		r = setTimeout(() => {
			i(Xe(`Timed out while ${n}`));
		}, t);
	});
...
function Qe() {
	return typeof window < "u" && typeof document < "u" && $e();
}
function $e() {
...
function nt(e) {
	...
	for (let n of e) for (let e of tt(n)) t.add(e);
	return [...t];
}
function rt(e, t, n) {
	let r = e?.routes?.[t]?.load;
	if (typeof r != "function") throw Xe(`No load() route for ${t} in ${n}`);
	return r;
}
async function it(e, t, n) {
	if (!Qe()) throw Xe("A DOM environment is required to load Home Assistant components");
	await Ze(customElements.whenDefined("partial-panel-resolver"), n, "waiting for partial-panel-resolver");
	let r = document.createElement("partial-panel-resolver");
	if (!r) throw Xe("Failed to create partial-panel-resolver");
	let i = { [t]: {
		url_path: t,
		component_name: e
	} }, a;
	...
	} else throw Xe("partial-panel-resolver exposes neither _getRoutes() nor _updateRoutes()");
	await Ze(rt(a, t, "partial-panel-resolver").call(a?.routes?.[t]), n, `loading ${e} panel`);
}
async function at(e) {
	await it("config", "tmp", e), await Ze(customElements.whenDefined("ha-panel-config"), e, "waiting for ha-panel-config");
	let t = document.createElement("ha-panel-config");
	if (!t) throw Xe("Failed to create ha-panel-config");
	await Ze(rt(t.routerOptions, "automation", "ha-panel-config").call(t.routerOptions?.routes?.automation), e, "loading automation route");
}
function ot(e) {
	return it("history", "history", e);
}
var st = {
	"config-automation": at,
	history: ot
};
function ct(e, t) {
	let n = Ke.get(e);
	if (n) return n;
	let r;
	return r = st[e](t).catch((t) => {
		throw Ke.get(e) === r && Ke.delete(e), t;
	}), Ke.set(e, r), r;
}
function lt(e, t, n) {
	let r = e.filter((e) => !et(e)), i = new Set(t);
	return {
		requested: [...e],
		alreadyDefined: [...t],
...
function ut(e, t) {
	for (let [n, r] of t) e.some((e) => tt(e).includes(n)) && Ke.get(n) === r && Ke.delete(n);
}
async function dt(e, t) {
	let n = Je(e), r = [], i = $e() ? n.filter(et) : [];
	if (i.length === n.length) return lt(n, i, r);
	if (!Qe()) {
		let e = new Set(i);
		throw new Ue({
			requested: [...n],
		...
		}, Xe("A DOM environment is required to load Home Assistant components"));
	}
	let a = Ye(t?.timeoutMs), o = /* @__PURE__ */ new Map(), s;
	try {
		for (let e of nt(n.filter((e) => !i.includes(e)))) {
			if (!n.filter((e) => !et(e)).some((t) => tt(t).includes(e))) continue;
			r.push(e);
			let t = ct(e, a);
			o.set(e, t), await t;
		}
	...
	let c = lt(n, i, r);
	if (s !== void 0 || c.missing.length > 0) throw ut(c.missing, o), new Ue(c, s);
	return c;
}
//#endregion
//#region node_modules/@kipk/ha-better-history/dist/all.js
var ft = /* @__PURE__ */ new Set(["unknown", "unavailable"]);
function pt(e) {
	return e == null || typeof e == "string" && ft.has(e);
}
function mt(e) {
	if (!(pt(e) || typeof e != "string" || e.trim() === "")) return e;
}
function ht(e) {
	if (pt(e)) return;
...
var vt = 6e4, yt = 3, bt = 350, xt = 216e5, St = 36e5, Ct = 432e5, wt = 2500, Tt = 8e3, Et = 15e3, Dt = 300, Ot = 700, kt = 1100, At = 80;
function jt(e) {
...
function zt(e) {
	...
	let n = It(e).toLowerCase(), r = `${Rt(e)} ${n}`;
...
function Gt(e) {
	let t = Number(e.state), n = e.attributes.unit_of_measurement, r = e.attributes.state_class, i = typeof r == "string" && r.trim() !== "" || typeof n == "string" && n.trim() !== "", a = pt(e.state) && i ? "number" : Wt(Number.isFinite(t) ? t : e.state);
	if (a) return {
...
function Kt(e, t, n) {
	let r = Pt(e.attributes, t), i = Wt(typeof r == "string" && Number.isFinite(Number(r)) ? Number(r) : r);
	if (i) return {
...
function qt(e, t) {
	return t === "number" ? ht(e) : t === "boolean" ? typeof e == "boolean" ? e : void 0 : mt(e);
}
function Jt(e, t) {
	let n = e.attributes ?? e.a ?? {};
	return qt(t.kind === "entity_state" ? e.state ?? e.s : Pt(n, t.path ?? []), t.valueType);
}
function Yt(e) {
...
function Qt(e, t, n = Date.now()) {
	...
	}, a = Jt(i, t), o = Yt(i), s = Number.isFinite(o) ? o : n;
...
var en = class {
	...
	hasCoverage(e, t, n, r) {
		...
		return i ? nn(r === "full" ? i.fullCoverage : [...i.stateCoverage, ...i.fullCoverage], t.getTime(), n.getTime()) : !1;
	}
	missingIntervals(e, t, n, r) {
		let i = this._entities.get(e);
		return an(i ? r === "full" ? i.fullCoverage : [...i.stateCoverage, ...i.fullCoverage] : [], t.getTime(), n.getTime()).map((e) => ({
	...
	integrate(e, t, n, r, i) {
		...
		a.states = on([...a.states, ...t]), a.stateCoverage = tn([...a.stateCoverage, {
			startTime: n.getTime(),
			endTime: r.getTime()
		}]), i === "full" && (a.fullCoverage = tn([...a.fullCoverage, {
			startTime: n.getTime(),
			endTime: r.getTime()
	...
	buildSeries(e, t, n, r) {
		...
		return dn(e, this._entities.get(e.entityId)?.states ?? [], t, n, new Date(a));
	}
	coverageEnd(e, t, n, r) {
		let i = this._entities.get(e);
		return i ? rn(r === "full" ? i.fullCoverage : [...i.stateCoverage, ...i.fullCoverage], t.getTime(), n.getTime()) : n.getTime();
	}
};
function tn(e) {
...
function rn(e, t, n) {
	if (n <= t) return n;
	let r = t;
	for (let t of tn(e)) if (!(t.endTime < r)) {
...
function an(e, t, n) {
	if (n <= t) return [];
	let r = [], i = t;
	for (let t of tn(e)) if (!(t.endTime <= i) && (t.startTime > i + 1 && r.push({
		startTime: i,
...
function sn(e, t) {
	let n = t.normalizeDurationMs + t.mergeDurationMs + t.buildDurationMs, r = t.stateCount >= Et || t.requestDurationMs >= kt, i = r || t.stateCount >= Tt || t.requestDurationMs >= Ot || n >= At, a = t.stateCount <= wt && t.requestDurationMs <= Dt && n <= At / 2;
	return i && e > St ? {
		nextChunkMs: Math.max(St, Math.floor(e / (r ? 4 : 2))),
		reason: "decrease"
	} : a && e < Ct ? {
		nextChunkMs: Math.min(Ct, e * 2),
		reason: "increase"
	} : {
		nextChunkMs: e,
		reason: "keep"
...
async function cn(e, t, n, r, i, a, o) {
...
async function ln(e, t) {
	...
	for (;;) {
		...
		try {
			...
			let i = zt(e), a = i && n < t.maxAttempts && !t.isCancelled?.();
			if (t.onPerformance?.({
			...
			await Vt(Bt(n, t.retryBaseDelayMs)), n += 1;
		}
	}
}
async function un(e, t, n, r, i, a, o = {}) {
	if (!e.callWS && !e.callApi) throw Error("Home Assistant history API is unavailable");
	let s = [...new Set(t.map((e) => e.entityId))], c = new Set(t.filter((e) => e.kind === "entity_state").map((e) => e.entityId)), l = new Set(t.filter((e) => e.kind === "entity_attribute").map((e) => e.entityId)), u = s.filter((e) => c.has(e)), d = s.filter((e) => l.has(e)), f = o.accumulator ?? new en(), p = [], m = Math.max(1, Math.floor(o.chunkTimeoutMs ?? vt)), h = Math.max(1, Math.floor(o.maxChunkAttempts ?? yt)), g = Math.max(0, Math.floor(o.chunkRetryBaseDelayMs ?? bt)), _ = (e, t) => ln(t, {
		taskId: e,
		timeoutMs: m,
		maxAttempts: h,
		retryBaseDelayMs: g,
		...
		onPerformance: a
	}), ee = /* @__PURE__ */ new Map(), v = (e, t, n, r, i, a, o) => {
		let s = [
			r,
			t.toISOString(),
			n.toISOString(),
	...
	for (let e of u) for (let t of f.missingIntervals(e, n, r, "state")) v(e, t.start, t.end, "state", !0, !0, !0);
	for (let e of d) for (let t of f.missingIntervals(e, n, r, "full")) y.push({
		entityId: e,
		start: t.start,
		end: t.end
	});
	let te = y.reduce((e, t) => {
		...
		return e + Math.max(1, Math.ceil(n / xt));
	}, 0), b = ee.size + te, x = 0, ne = /* @__PURE__ */ new Set(), re = async (s, c, l) => {
		let u = x;
		...
		await Ht();
		let d = A(), p = Zt(c, s.entityIds), m = A() - d, h = [...p.values()].reduce((e, t) => e + t.length, 0);
		a?.({
			event: "history.batch",
			details: {
				batchIndex: u,
	...
	for (let t of ee.values()) {
		...
		p.push({
			...
			run: () => _(i, () => cn(e, r, t.start, t.end, t.minimalResponse, t.noAttributes, t.significantChangesOnly))
		});
	}
	a?.({
		event: "history.start",
		details: {
			...
			batchCount: b,
			attributeChunkHours: xt / 36e5,
			minAttributeChunkHours: St / 36e5,
			maxAttributeChunkHours: Ct / 36e5,
	...
	for (let t of y) {
		...
		for (let r = t.start.getTime(); r < t.end.getTime() && !o.isCancelled?.();) {
			...
			let l = A(), u = await _(c, () => cn(e, [t.entityId], i, o, !1, !1, !1)), d = A() - l;
			ie += 1, a?.({
...
function dn(e, t, n, r, i) {
	...
	return {
		source: e,
		points: jt(a.length > 0 ? Xt(a, r, i) : $t(n, e, r, i))
	};
}
var fn = 6e4, pn = 48;
function mn(e) {
...
var bn = class {
	...
	_hasActiveEntityLoad(e, t) {
		return (e.activeEntityLoads.get(gn(t)) ?? 0) > 0;
	}
	_beginLoad(e, t) {
		e.activeLoads += 1;
		for (let n of t) {
	...
	_completeLoad(e, t) {
		...
		for (let n of t) {
			let t = gn(n), r = Math.max(0, (e.activeEntityLoads.get(t) ?? 0) - 1);
	...
	_requestProgressUpdate(e) {
		...
		let t = A() - this._lastProgressUpdateMs, n = Math.max(0, pn - t);
		setTimeout(() => {
	...
	fetch(e, t, n, r) {
		let i = `${_t(t)}|${n.getTime()}|${r.getTime()}`;
		...
		this.series = [], this.changedSourceIds = /* @__PURE__ */ new Set(), this.loading = !0, this.error = "", this._beginLoad(a, t), this.debugPerformance && j(this.debugPerformance, "controller.fetch_start", {
			...
			sourceCount: t.length,
			rangeHours: Math.round((r.getTime() - n.getTime()) / 36e3) / 100
		}), this.host.requestUpdate(), un(e, a.sources, n, r, (t, i) => {
			...
			this._isCurrentSession(a) && mn(() => {
				...
				_n(this.series, l) || (this.series = l), this.changedSourceIds = /* @__PURE__ */ new Set();
			...
			if (this._isCurrentSession(a)) {
				...
				this.error = hn(e), this._completeLoad(a, t), this.host.requestUpdate(), this.debugPerformance && j(this.debugPerformance, "controller.fetch_error", {
					sessionId: a.id,
					totalDurationMs: Math.round(A() - o),
					error: this.error
				});
	...
	setImportedSeries(e, t, n) {
		this._cancelSession(), this.series = e, this.changedSourceIds = new Set(e.map((e) => e.source.id)), this.loading = !1, this.error = "", this._prevKey = `${_t(e.map((e) => e.source))}|${t.getTime()}|${n.getTime()}`, this.host.requestUpdate();
	}
	setError(e) {
	...
	addSources(e, t, n, r) {
		...
		let c = o.filter((e) => !this._hasActiveEntityLoad(i, e)), l = new Set(c.map((e) => e.id)), u = i.sources.filter((e) => l.has(e.id) || !s.has(gn(e))), d = A();
		...
		this.loading = !0, this._beginLoad(i, c), this.debugPerformance && j(this.debugPerformance, "controller.add_sources_start", {
			...
			existingSourceCount: this.series.length,
			rangeHours: Math.round((r.getTime() - n.getTime()) / 36e3) / 100
		}), this.host.requestUpdate(), un(e, u, n, r, (t, a) => {
			...
			this._isCurrentSession(i) && mn(() => {
				if (!this._isCurrentSession(i)) return;
				let a = A(), o = this._availableSessionSeries(i, e, n, r, t), s = this._mergeSeries(this.series, o);
				_n(this.series, s) || (this.series = s), this.changedSourceIds = /* @__PURE__ */ new Set();
			...
			if (this._isCurrentSession(i)) {
				...
				this.error = hn(e), this._completeLoad(i, c), this.host.requestUpdate(), this.debugPerformance && j(this.debugPerformance, "controller.add_sources_error", {
					sessionId: i.id,
					totalDurationMs: Math.round(A() - d),
					error: this.error
				});
	...
	removeSources(e) {
		...
		this._prevKey = `${_t(this.series.map((e) => e.source))}|`, this.host.requestUpdate();
	}
}, xn = [
	"#ff9800",
	"#42a5f5",
	...
	temperature: "#ff9800"
}, Cn = new Set(Object.values(Sn)), wn = xn.filter((e) => !Cn.has(e)), Tn = /* @__PURE__ */ new Set([
	"primary",
	"accent",
	"red",
	"pink",
...
function kn(e) {
	...
	if (Tn.has(t)) return `var(--${t}-color, ${n !== t && On(n) ? n : t})`;
	if (On(t)) return t;
	if (n !== t && On(n)) return n;
}
function An(e) {
...
function jn(e, t, n) {
	let r = kn(e);
	if (r && !t.has(Dn(r))) return r;
	let i = [
		...wn.slice(n % wn.length),
		...wn.slice(0, n % wn.length),
		...xn
	];
	for (let e of i) if (!t.has(Dn(e))) return e;
	let a = n, o = An(a);
	for (; t.has(Dn(o));) a += 1, o = An(a);
	return o;
}
function Mn(e) {
	return Dn(e);
...
function Rn(e, t, n = 5) {
	...
	let r = Math.abs(t - e);
	if (r < 1e-10) return [e];
	let i = zn(r / (Math.max(n, 2) - 1)), a = Math.floor(e / i) * i, o = Math.ceil(t / i) * i, s = i * 1e-8, c = [];
	for (let e = a; e <= o + s; e += i) c.push(Bn(e, i));
	return c;
}
function zn(e) {
	if (e <= 0) return 1;
...
function Xn(e, t) {
	let n = Math.abs(Yn(qn(e)) - Yn(qn(t))), r = Math.abs(Yn(Jn(e)) - Yn(Jn(t))), i = Zn(e.unit) === Zn(t.unit) ? 0 : 2;
	return n + r * .6 + i;
}
function Zn(e) {
	return Fn(e);
...
function $n(e) {
	...
	let a = Math.min(...i), o = Math.max(...i), s = i.find((e) => e / r <= Wn);
	return s !== void 0 && r / s >= Kn && (o / Math.max(a, 1e-9) >= Gn || r / a >= Gn);
}
function er(e) {
...
function nr(e, t) {
	let n = rr(e);
	return n.length >= 2 ? [n[0].series, n[1].series] : tr(e, t);
}
function rr(e) {
	let t = [];
	for (let n of e) {
		let e = Zn(n.unit), r = t.find((t) => t.unit === e);
...
function ar(e, t, n, r, i) {
	let a = Math.min(...r.map((e) => e.min)), o = Math.max(...r.map((e) => e.max)), s = Math.max(...r.map((e) => e.precision)), c = Hn(a, o, s), l = Rn(c.min, c.max);
	return {
...
function or(e, t = {}) {
	...
	for (let [t, n] of e.entries()) {
		...
		let e = n.points.map((e) => Number(e.value)).filter((e) => Number.isFinite(e)), i = n.scaleMode === "manual" && n.scaleMin !== void 0 ? n.scaleMin : 0, a = n.scaleMode === "manual" && n.scaleMax !== void 0 ? n.scaleMax : 1, o = n.valueType === "boolean" ? 0 : e.length > 0 ? Math.min(...e) : Math.min(i, a), s = n.valueType === "boolean" ? 1 : e.length > 0 ? Math.max(...e) : Math.max(i, a), c = n.valueType === "boolean" || e.length === 0 ? 0 : Math.max(...e.map((e) => In(e))), l = n.valueType === "boolean" ? "group:boolean" : n.scaleGroupKey, u = r.find((e) => e.key === l);
		u || (u = {
			key: l,
			series: []
	...
	let i = 0;
	return r.flatMap((e) => (e.key === "group:boolean" ? [e.series] : ir(e.series)).flatMap((t, r) => {
		let a = r === 0 ? e.key : `${e.key}::unit-graph:${r + 1}`, o = n && e.key !== "group:temperature" && !Qn(t), [s, c] = e.key === "group:boolean" ? [t, []] : nr(t, o), l = 28 + i++ * 214, u = ar(a, e.key, "left", s, l);
		return c.length > 0 ? [u, ar(a, e.key, "right", c, l)] : [u];
	}));
}
function sr(e, t, n, r) {
	let i = e.map((e) => ({
...
function fr(e, t, n) {
	...
	return s.length === 0 ? [] : pr(a.points, n).filter((e) => e.value === "heating").reduce((e, t) => {
		let n = e[e.length - 1];
		...
		let c = o.top + o.height, l = [
			`${cr(e, n).toFixed(1)},${c.toFixed(1)}`,
			...i.map((e) => `${cr(e.time, n).toFixed(1)},${lr(e.value, o).toFixed(1)}`),
			`${cr(t, n).toFixed(1)},${c.toFixed(1)}`
		].join(" ");
		return [{
			id: `${a.id}:heat:${r}`,
			points: l
...
function yr(e, t, n, r) {
	...
	let i = String(e);
	return vr.has(i.toLowerCase()) ? "var(--better-history-muted-color, var(--secondary-text-color, #888))" : (n.has(i) || n.set(i, xn[(r + n.size) % xn.length]), n.get(i));
}
function br(e, t) {
...
function xr(e, t, n, r) {
	return e.flatMap((e) => {
		...
		let i = hr(e, t);
		if (!i) return [];
		let a = sr(Sr(e.points, n, e.lineMode, r), n, 40, 640), { points: o, pathLength: s } = e.lineMode === "line" ? Ar(a, n, i) : kr(a, n, i);
		return [{
			id: e.id,
			color: e.color,
			points: o,
...
function Er(e, t, n, r) {
	return e.flatMap((e) => {
		...
		return _r(e, n, r.extendColumnToEnd).flatMap((t, r) => {
			...
			let s = N(t.start, n), c = N(t.end, n), l = mr(o, i), u = Math.max(c - s, 1);
			return [{
				id: `${e.id}:${r}`,
				x: s,
				y: Math.min(l, a),
...
function kr(e, t, n) {
	...
	if (e.length === 1) return {
		points: `${N(e[0].time, t).toFixed(1)},${mr(e[0].value, n).toFixed(1)}`,
		pathLength: 0
	};
	let r = [], i = 0;
	for (let a = 0; a < e.length - 1; a++) {
		let o = e[a], s = e[a + 1], c = N(o.time, t), l = mr(o.value, n), u = N(s.time, t), d = mr(s.value, n);
...
function Ar(e, t, n) {
	...
	return {
		points: e.map((e) => {
			let a = N(e.time, t), o = mr(e.value, n);
...
function Gr(e, t, n, r = !1, i = 12, a = !0, o = !0) {
	let s = { extendStairToEnd: a }, c = { extendColumnToEnd: a }, l = or(Wr(e, t, n), { autoScaleSplit: o }), u = new Set(l.map((e) => e.graphKey)).size, d = Un(u), f = e.filter((e) => e.valueType !== "number" && e.valueType !== "boolean").length, p = Lr(n.start, n.end, i), m = n.end - n.start;
	return {
		allSeries: e,
		visibleSeries: t,
		timeBounds: n,
...
function qr(e, t, n) {
	return e.map((e) => `M${N(e.time, t).toFixed(2)},${mr(e.value, n).toFixed(2)}h0`).join("");
}
function Jr(e, t, n, r, i) {
	...
	for (let s of e) {
		...
		let c = {
			...
			top: 28,
			height: i
		}, l = sr(Sr(s.points, n, s.lineMode, r), n, 40, 640), { points: u, pathLength: d } = s.lineMode === "line" ? Ar(l, n, c) : kr(l, n, c);
		if (a.push({
			id: s.id,
			color: s.color,
			points: u,
...
function Yr(e, t, n, r, i) {
	return e.filter((e) => (e.valueType === "number" || e.valueType === "boolean") && e.lineMode === "column").flatMap((e) => {
		...
		return _r(e, n, i.extendColumnToEnd).flatMap((t, r) => {
			...
			let a = N(t.start, n), c = N(t.end, n), l = mr(i, o);
			return [{
				id: `${e.id}:${r}`,
				x: a,
				y: Math.min(l, s),
...
function Qr(e, t) {
	let n = t - 10, r = Zr(t), i = e.ticks.length <= r ? e.ticks : Rn(e.min, e.max, r), a = Math.max(Math.abs(e.max - e.min), 1) * 1e-9, o = i.filter((t) => t >= e.min - a && t <= e.max + a), s = o.length > 0 ? o : [e.min, e.max], c = e.ticks === i ? e.precision : Math.max(e.precision, Vn(s));
	return s.map((t) => ({
...
function $r(e, t, n) {
	...
	return {
		allSeries: e.map((e, t) => {
			let a = jn(e.color, r, n * xn.length + t);
			return r.add(Mn(a)), i.set(e.id, a), a === e.color ? e : {
				...e,
				color: a
			};
		}),
...
function ti(e, t = 12, n = 180) {
	...
	for (let t = 0; t < l.length; t++) {
		let s = l[t], d = e.numericScales.filter((e) => e.graphKey === s), f = d.find((e) => e.axis === "left") ?? d[0], p = d.find((e) => e.axis === "right"), m = new Set(d.flatMap((e) => [...e.ids])), h = d[0]?.sourceGraphKey ?? s, g = e.allSeries.filter((e) => (e.valueType === "number" || e.valueType === "boolean") && Vr(e) === h), _ = g.filter((e) => Ur(e, g) === s), ee = e.visibleSeries.filter((e) => m.has(e.id)), v = ei(o, u, t, !0), y = ei(a, u, t, !0), te = [...ee, ...v], b = $r([..._, ...y], te, t), x = b.visibleSeries.filter((e) => e.valueType !== "number" && e.valueType !== "boolean"), ne = x.length, re = 28 + n + 16 + 6, S = ne > 0 ? 22 + ne * 14 : 0, ie = 28 + n + S + 18, ae = ie + (ne > 0 ? 0 : 16), C = Qr(f, n), oe = p ? Qr(p, n) : [], se = d.map((e) => ({
			...e,
			top: 28,
			height: n
		})), ce = se.find((e) => e.axis === "left") ?? se[0], le = Jr(b.visibleSeries, se, i, { extendStairToEnd: e.extendStairToEnd }, n);
		r.push({
			series: b.visibleSeries,
			allSeries: b.allSeries,
			scale: ce,
			scales: se,
			graphHeight: n,
			svgHeight: ie,
			...
			columns: Yr(b.visibleSeries, se, i, n, { extendColumnToEnd: e.extendStairToEnd }),
			segments: Xr(x, re, i),
			yLabels: C,
			rightYLabels: oe,
			xLabels: c,
			heatingAreas: e.heatingAreas.length > 0 ? fr(e.visibleSeries, se, i) : []
		});
	}
	return r;
}
...
function xi(e, t, n) {
	let r = e?.states[t];
	return r ? n ? Kt(r, n)?.valueType ?? "string" : Gt(r)?.valueType ?? "string" : "number";
}
function Si(e, t, n) {
	let r = e?.states[t];
	return !r || pt(n ? n.reduce((e, t) => typeof e == "object" && e ? e[t] : void 0, r.attributes) : r.state);
}
function Ci(e) {
...
function Mi(e, t, n) {
	...
	return [e, ...di.map((a) => {
		let o = [a], s = yi(e.entity, o), c = xi(n, e.entity, o), l = Sn[a] ?? En(t()), u = a === "current_temperature" || a === "temperature" ? r : void 0, d = a === "hvac_action" ? void 0 : i ?? "temperature";
		return {
			id: s,
			entity: e.entity,
			attribute: o,
...
function Pi(e) {
	...
	return e.map((e) => {
		let r = ai(e.unit), i = Oi(e), a = t && (r || Pn(e.unit, t) || e.unit === void 0 && i) ? t : e.unit, o = e.scaleGroupKey;
		if (a && o.startsWith("unit:")) {
			let e = o.slice(5);
			(r && e === "temperature" || Pn(e, a)) && (o = `unit:${a}`);
		}
		return n && e.valueType === "number" && a && M(a) && o.startsWith("unit:") && !fi(e) && (o = "group:temperature"), a !== e.unit || o !== e.scaleGroupKey ? {
			...e,
			unit: a,
			scaleGroupKey: o
		} : e;
...
function ba(e, t) {
    ...
    >
      <span class="source-chip-icon">
        ${i && a ? w`<ha-icon .icon=${ya(a)}></ha-icon>` : w`<ha-icon .icon=${Sa(e.valueType)}></ha-icon>`}
      </span>
...
function Ca(e) {
    ...
    <div class="entity-browser">
      ...
      <div class="entity-browser-list">
        ${t ? Ta(t, n, $i(r) ? r : {}, e) : w`<div class="entity-browser-empty">${P(e.hass, "no_entity_selected")}</div>`}
      </div>
    </div>
  `;
}
...
function Ta(e, t, n, r) {
	let i = Object.entries(n).sort(([e], [t]) => e.localeCompare(t)), a = i.some(([n, r]) => $i(r) ? !0 : Wt(r) !== void 0 && !!Kt(e, [...t, n]));
	return w`
...
function Oo(e) {
	let t = Do(e);
	return t ? e.map((e) => {
		let n = Pn(e.unit, t) || e.unit === void 0 && Eo(e) ? t : e.unit;
		return n === e.unit ? e : {
			...e,
			unit: n
		};
...
var I = class extends D {
	...
	_resolvedSourceValueTypePromotionPending() {
		...
		return this._lastFetchSources.some((t) => {
			...
			if (!n) return !1;
			let r = t.kind === "entity_attribute" ? Kt(n, t.path ?? []) : Gt(n);
	...
	willUpdate(e) {
		...
		if (u.some((t) => e.has(t))) {
			...
			let o = this._fetchSources(), s = _t(o), c = t ? `${s}|rolling|${this._relativeRangeMs()}` : `${s}|${i.startDate.getTime()}|${i.endDate.getTime()}`;
			if (c !== this._lastFetchKey) {
				let e = s === _t(this._lastFetchSources) && this._lastFetchKey !== "";
	...
	_pickScaleGroup(e, t, n) {
		...
		if (e.unit) {
			let n = t.find((t) => t.valueType === "number" && (t.unit === e.unit || Pn(t.unit, e.unit)));
			if (n) return n.scaleGroupKey;
			let r = this._resolved?.series.find((t) => t.valueType === "number" && (t.unit === e.unit || Pn(t.unit, e.unit)));
	...
	_renderSeriesFromSource(e, t, n, r, i = e.unit) {
		...
		return {
			...
			entity: e.entityId,
			label: e.label,
			color: o?.color ?? (a ? Sn[a] : void 0) ?? En(r),
			unit: i,
			scaleGroupKey: n,
			scaleMode: "auto",
	...
	_unitForScaleGroup(e, t, n) {
		...
		let r = n.find((n) => n.scaleGroupKey === t && Pn(n.unit, e.unit));
		return r?.unit ? r.unit : this._activeResolvedSeries().find((n) => n.scaleGroupKey === t && Pn(n.unit, e.unit))?.unit ?? e.unit;
	}
	_defaultLineMode() {
	...
	_chartData() {
		...
		}, p = this._data.debugPerformance, m = p ? A() : 0, h = Gr(u, d, f, this._resolved?.disableClimateOverlay ?? !1, l, s, c), g = p ? A() - m : 0;
	...
	_renderEntityPickerUI() {
		return !this._resolved?.showEntityPicker || !this._entityComponentsReady ? E : ma({
			hass: this.hass,
	...
	_applyImportedData(e) {
		...
		let o = _t(this._selectedSources);
	...
	_renderDatePicker() {
		return !this._resolved?.showDatePicker || !this._datePickerReady ? E : Ji({
			hass: this.hass,
...
F([O({ attribute: !1 })], I.prototype, "hass", void 0), F([O({ attribute: !1 })], I.prototype, "config", void 0), F([O({ attribute: !1 })], I.prototype, "entities", void 0), F([O({ attribute: !1 })], I.prototype, "attributeUnits", void 0), F([O({ type: Number })], I.prototype, "hours", void 0), F([O({ attribute: !1 })], I.prototype, "startDate", void 0), F([O({ attribute: !1 })], I.prototype, "endDate", void 0), F([O({
	type: Boolean,
	attribute: "show-date-picker"
})], I.prototype, "showDatePicker", void 0), F([O({
	type: Boolean,
	attribute: "show-entity-picker"
})], I.prototype, "showEntityPicker", void 0), F([O({
	type: Boolean,
	attribute: "show-import-button"
})], I.prototype, "showImportButton", void 0), F([O({
	type: Boolean,
	attribute: "show-export-button"
})], I.prototype, "showExportButton", void 0), F([O({
	type: Boolean,
	attribute: "show-time-range-selector"
})], I.prototype, "showTimeRangeSelector", void 0), F([O({
	type: Boolean,
	attribute: "show-line-mode-buttons"
})], I.prototype, "showLineModeButtons", void 0), F([O({
	type: Boolean,
	attribute: "show-legend"
})], I.prototype, "showLegend", void 0), F([O({
	type: Boolean,
	attribute: "show-tooltip"
})], I.prototype, "showTooltip", void 0), F([O({
	type: Boolean,
	attribute: "show-grid"
})], I.prototype, "showGrid", void 0), F([O({
	type: Boolean,
	attribute: "show-scale"
})], I.prototype, "showScale", void 0), F([O({
	type: Boolean,
	attribute: "auto-scale-split"
})], I.prototype, "autoScaleSplit", void 0), F([O({
	type: Boolean,
	attribute: "show-controls"
})], I.prototype, "showControls", void 0), F([O()], I.prototype, "width", void 0), F([O()], I.prototype, "height", void 0), F([O({ attribute: "line-mode" })], I.prototype, "lineMode", void 0), F([O({ attribute: "line-width" })], I.prototype, "lineWidth", void 0), F([O({ attribute: "background-color" })], I.prototype, "backgroundColor", void 0), F([O({ attribute: "graph-title" })], I.prototype, "graphTitle", void 0), F([O({ attribute: "title-font-family" })], I.prototype, "titleFontFamily", void 0), F([O({ attribute: "title-font-size" })], I.prototype, "titleFontSize", void 0), F([O({ attribute: "title-color" })], I.prototype, "titleColor", void 0), F([O()], I.prototype, "language", void 0), F([O({
	type: Boolean,
	attribute: "debug-performance"
})], I.prototype, "debugPerformance", void 0), F([O({
	type: Boolean,
	attribute: "tools-open"
})], I.prototype, "toolsOpen", void 0), F([k()], I.prototype, "_resolved", void 0), F([k()], I.prototype, "_hiddenSeriesIds", void 0), F([k()], I.prototype, "_rangeStart", void 0), F([k()], I.prototype, "_rangeEnd", void 0), F([k()], I.prototype, "_viewStart", void 0), F([k()], I.prototype, "_viewEnd", void 0), F([k()], I.prototype, "_liveNow", void 0), F([k()], I.prototype, "_datePickerReady", void 0), F([k()], I.prototype, "_entityComponentsReady", void 0), F([k()], I.prototype, "_runtimeLineMode", void 0), F([k()], I.prototype, "_attributeMenuOpen", void 0), F([k()], I.prototype, "_attributeSearch", void 0), F([k()], I.prototype, "_selectedEntityId", void 0), F([k()], I.prototype, "_path", void 0), F([k()], I.prototype, "_selectedSources", void 0), F([k()], I.prototype, "_removedConfigSourceIds", void 0), F([k()], I.prototype, "_scalePreferences", void 0), F([k()], I.prototype, "_customEntityIds", void 0), F([k()], I.prototype, "_entityPickerOpen", void 0), F([k()], I.prototype, "_datePickerOpen", void 0), F([k()], I.prototype, "_draggingSourceId", void 0), F([k()], I.prototype, "_draggingAxisSeriesId", void 0), F([k()], I.prototype, "_axisDropTarget", void 0), F([k()], I.prototype, "_sourceSettingsSourceId", void 0), F([k()], I.prototype, "_pendingAddedSources", void 0), F([k()], I.prototype, "_importedDataActive", void 0), F([k()], I.prototype, "_containerWidth", void 0), F([k()], I.prototype, "_chartSurfaceHeight", void 0), F([k()], I.prototype, "_chartSurfaceConstrained", void 0);
...
F([O({ attribute: !1 })], L.prototype, "hass", void 0), F([O({ attribute: !1 })], L.prototype, "initialSources", void 0), F([O({
	type: Boolean,
	attribute: "browser-history"
})], L.prototype, "browserHistory", void 0), F([k()], L.prototype, "_selectedSources", void 0), F([k()], L.prototype, "_attributeMenuOpen", void 0), F([k()], L.prototype, "_entityPickerOpen", void 0), F([k()], L.prototype, "_selectedEntityId", void 0), F([k()], L.prototype, "_entitySearch", void 0), F([k()], L.prototype, "_path", void 0), F([k()], L.prototype, "_attributeSearch", void 0), F([k()], L.prototype, "_componentsReady", void 0), F([k()], L.prototype, "_customEntityIds", void 0), F([k()], L.prototype, "_sourceSettingsSourceId", void 0), customElements.get("abh-series-picker") || customElements.define("abh-series-picker", L);
...
new Set($o);
for (let [e, t] of Object.entries(Qo)) es.set(e, t);
function ts(e) {
...
function R(e, t, n = {}) {
	let r = ns(rs(e)), i = ns("en");
	return as((r == null ? void 0 : is(r, t)) ?? (i == null ? void 0 : is(i, t)) ?? t, n);
}
//#endregion
...
}, ss = Object.keys(os), cs = (e, t) => Object.prototype.hasOwnProperty.call(e, t);
function ls(e, t, n) {
	let r = e?.mode_customizations?.[t];
	return n !== void 0 && r && cs(r, n) ? r[n] : void 0;
}
function us(e, t, n) {
	return ls(e, t, n)?.hidden === !0 ? !0 : t === "hvac" ? e?.hidden_hvac_modes?.includes(n) === !0 : t === "preset" && e?.hidden_preset_modes?.includes(n) === !0;
}
function ds({ config: e, language: t, family: n, mode: r }) {
	let i = ls(e, n, r)?.label;
	if (i) return i;
...
function B({ config: e, family: t, mode: n, defaultTone: r }) {
	let i = ls(e, t, n)?.tone;
	return i && os[t].includes(i) ? i : r ?? "";
}
function V({ config: e, family: t, modes: n, standardOrder: r }) {
	let i = [...new Set(n)], a = new Set(i);
	return [...r.filter((e) => a.has(e)), ...i.filter((e) => !r.includes(e))].filter((n) => !us(e, t, n));
}
function fs(e) {
	...
	for (let e of ss) {
		...
		for (let [t, n] of Object.entries(r)) {
			...
			o && (a.label = o), s.startsWith("mdi:") && (a.icon = s), os[e].includes(c) && (a.tone = c), r.hidden === !0 && (a.hidden = !0), Object.keys(a).length > 0 && Object.defineProperty(i, t, {
				value: a,
				enumerable: !0,
				configurable: !0,
				writable: !0
...
function gs() {
	return ps.every((e) => customElements.get(e)) ? Promise.resolve() : (ms ??= _s(), ms);
}
async function _s() {
	try {
		await dt(ps);
	} catch (e) {
		throw ms = void 0, hs || (hs = !0, e instanceof Ue ? console.warn(`[equinox-card] Failed to load Home Assistant UI components. Missing: ${e.result.missing.join(", ") || "unknown"}.`, e.cause ?? e) : console.warn("[equinox-card] Failed to load Home Assistant UI components.", e)), e;
	}
}
//#endregion
//#region src/types/config.ts
var vs = ["flat", "liquid_glow"], ys = [
	"classic",
	"compact",
	"thin"
], bs = ["setpoint", "sensors"], xs = ["slider", "buttons"], Ss = [
	"auto",
	"custom",
	"disabled"
], Cs = ["horizontal", "vertical"], ws = {
	theme: Lo,
	display_mode: Ro,
	primary_display: zo,
...
var Os = class extends D {
  ...
  `;
	...
	connectedCallback() {
		super.connectedCallback(), gs().catch(() => void 0);
	}
	setConfig(e) {
		this._config = Ds(e);
	}
      ...
      <div class="options-panel">
        ...
        ${n.length === 0 ? w`<div class="options-empty">${R(e, this._config.entity ? r : "editor.visibility.no_entity")}</div>` : w`
              <div class="checkbox-list">
                ${n.map((n) => {
			let r = this._modeCustomization(t, n), i = ds({
				language: e,
				family: t,
				mode: n
			});
			return w`<div class="mode-card">
                    ...
                    <div class="mode-fields">
                      ...
                      <label>${R(e, "editor.mode_customization.tone")}<select .value=${r.tone ?? ""} @change=${(e) => this._commitModeCustomization(t, n, { tone: e.currentTarget.value })}>
                        ...
                        ${os[t].map((e) => w`<option value=${e}>${e}</option>`)}
                      </select></label>
                    </div>
                  </div>`;
		})}
	...
	_modeField(e, t, n, r, i) {
		return w`<label>${R(e, `editor.mode_customization.${t}`)}<input
      type="text"
      .value=${n}
	...
	_colorChanged(e, t) {
		...
		r === void 0 || r === "" ? delete n[e] : n[e] = r, this._config = Ds(n), this._emitConfigChanged();
	}
	_climateEntity() {
	...
	_modeCustomization(e, t) {
		let n = ls(this._config, e, t) ?? {}, r = this._pendingModeCustomizations.get(e)?.get(t);
		if (!r) return n;
		let i = {
			...n,
			...r
	...
	_isModeHidden(e, t) {
		...
		return n && Object.prototype.hasOwnProperty.call(n, "hidden") ? n.hidden === !0 : us(this._config, e, t);
	}
	...
	_flushModeCustomizations() {
		...
		this._pendingModeCustomizations.clear(), this._config = Ds(e), this._emitConfigChanged();
	}
	_computeLabel(e) {
...
customElements.get("equinox-card-editor") || customElements.define(Io, Os);
//#endregion
...
async function Ps(e, t) {
	return As(e) ? js() : Ns(t.targetTempLow) && Ns(t.targetTempHigh) ? U(e, "climate", "set_temperature", {
		entity_id: e.entityId,
		target_temp_low: t.targetTempLow,
		target_temp_high: t.targetTempHigh
	}) : Ns(t.temperature) ? U(e, "climate", "set_temperature", {
		entity_id: e.entityId,
		temperature: t.temperature
	}) : Ms();
}
async function Fs(e, t) {
	return As(e) ? js() : e.viewModel?.climate.hvacModes.includes(t) ? U(e, "climate", "set_hvac_mode", {
		entity_id: e.entityId,
		hvac_mode: t
	}) : H();
}
async function Is(e, t) {
	return As(e) ? js() : e.viewModel?.climate.presetModes.includes(t) ? U(e, "climate", "set_preset_mode", {
		entity_id: e.entityId,
		preset_mode: t
	}) : H();
}
async function Ls(e, t) {
	return As(e) ? js() : e.viewModel?.climate.fanModes.includes(t) ? U(e, "climate", "set_fan_mode", {
		entity_id: e.entityId,
		fan_mode: t
	}) : H();
}
async function Rs(e, t) {
	return As(e) ? js() : e.viewModel?.climate.swingModes.includes(t) ? U(e, "climate", "set_swing_mode", {
		entity_id: e.entityId,
		swing_mode: t
	}) : H();
}
async function zs(e, t) {
	return As(e) ? js() : e.viewModel?.climate.swingHorizontalModes.includes(t) ? U(e, "climate", "set_swing_horizontal_mode", {
		entity_id: e.entityId,
		swing_horizontal_mode: t
	}) : H();
}
async function Bs(e, t, n) {
	return As(e) ? js() : !e.viewModel?.vt?.isVt || !e.viewModel.vt.timedPresetManager ? H() : !Number.isInteger(n) || n < 1 || n > 1440 || t.trim() === "" ? Ms() : U(e, "versatile_thermostat", "set_timed_preset", {
		entity_id: e.entityId,
		preset: t,
		duration_minutes: n
	});
...
async function Vs(e) {
	return As(e) ? js() : e.viewModel?.vt?.timedPreset.isActive ? U(e, "versatile_thermostat", "cancel_timed_preset", { entity_id: e.entityId }) : H();
}
async function Hs(e, t) {
	if (As(e)) return js();
	if (!e.viewModel?.vt?.fan.hasAutoFan) return H();
	let n = ks[t];
	return n ? U(e, "versatile_thermostat", "set_auto_fan_mode", {
		entity_id: e.entityId,
		auto_fan_mode: n
	}) : Ms();
}
async function Us(e, t) {
	if (!e.viewModel?.vt?.lock.isConfigured) return H();
	let n = { entity_id: e.entityId };
	return t && (n.code = t), U(e, "versatile_thermostat", "lock", n);
}
async function Ws(e, t) {
	if (!e.viewModel?.vt?.lock.isConfigured) return H();
	let n = { entity_id: e.entityId };
	return t && (n.code = t), U(e, "versatile_thermostat", "unlock", n);
}
//#endregion
...
function W(e) {
	return e ? e === "idle" ? "muted" : e === "off" ? "off" : Ks[Gs[e] ?? e] ?? "" : "";
}
function qs(e, t) {
	switch (e) {
...
function tc(e) {
	...
	let t = `${e.source}:${e.algorithm}`, n = ec.get(t);
	if (n) return n;
	let r = e.source === "custom" ? ic(e.algorithm) : Promise.resolve(rc(e.algorithm));
	return ec.set(t, r), r;
}
function nc(e) {
	if (!ac(e) || e.schema_version !== 1 || e.kind !== "regulation-dashboard" || !Array.isArray(e.sections) || e.sections.length === 0) return !1;
	let t = /* @__PURE__ */ new Set();
	return e.sections.every((e) => !ac(e) || typeof e.id != "string" || !oc(e.id) || !Array.isArray(e.items) || t.has(e.id) ? !1 : (t.add(e.id), e.items.every(sc)));
}
function rc(e) {
	let t = Qs(e);
	return t ? nc(t) ? {
...
function sc(e) {
	return !ac(e) || typeof e.type != "string" ? !1 : e.type === "layout_grid" ? Array.isArray(e.items) && e.items.every(sc) : [
		"hero_status",
		"value",
		"metric_grid",
		"status",
...
var cc = "specific_states/regulation_diagnostics";
function lc(e) {
...
function pc(e, t) {
	...
	return lc(dc(n, cc)) ?? lc(t.diagnostic_entity);
}
function mc(e, t) {
	let n = pc(e, t);
	return {
...
function hc(e, t) {
	return mc(e.hass, e.config)[t];
}
function gc(e, t, n) {
	let r = hc(e, t);
	if (!r) return;
	if (t === "config") return dc(r, n);
	let i = uc(n);
	if (i.length === 0) return r;
	let a = i[0];
	if (a === "state" || a === "attributes" || a === "entity_id") return dc(r, i);
	let o = dc(r.attributes, i);
	return o === void 0 ? dc(r, i) : o;
}
//#endregion
...
customElements.get("eq-dialog") || customElements.define("eq-dialog", Tc);
//#endregion
...
var Ec = class extends D {
  ...
  `;
	...
	_getOptions() {
		return this.viewModel?.vt?.fan.hasAutoFan === !0 ? Xo.filter((e) => !us(this.config, "fan", e)) : (this.viewModel?.climate.fanModes ?? []).filter((e) => !us(this.config, "fan", e));
	}
	_getActiveMode() {
	...
	async _selectMode(e) {
		...
		this.viewModel?.vt?.fan.hasAutoFan === !0 ? await Hs(t, e) : await Ls(t, e), this._dispatchClose();
	}
	render() {
...
customElements.get("eq-fan-dialog") || customElements.define("eq-fan-dialog", Ec);
//#endregion
...
customElements.get("eq-hvac-dialog") || customElements.define("eq-hvac-dialog", Dc);
//#endregion
      ...
      >
        <div class="swing-content">
          <div class="swing-desktop">
            ${e.length > 0 ? w`
                  <div class="group">
                    ${n ? w`<span class="group-title">${R(this.language, "dialog.swing.vertical")}</span>` : E}
                    ${this._renderDesktopGroup(e, this.viewModel?.climate.swingMode, !1, (e) => this._selectVerticalMode(e))}
                  </div>
                ` : E}
            ${t.length > 0 ? w`
                  <div class="group">
                    ${n ? w`<span class="group-title">${R(this.language, "dialog.swing.horizontal")}</span>` : E}
...
customElements.get("eq-swing-dialog") || customElements.define("eq-swing-dialog", Oc);
//#endregion
  ...
  `;
	...
	_presetTone(e) {
		return B({
			...
			family: "preset",
			mode: e,
			defaultTone: qs(e, this.viewModel?.climate.hvacMode)
		});
	}
	_dispatchClose() {
		this.dispatchEvent(new CustomEvent("eq-dialog-close", {
...
customElements.get("eq-preset-dialog") || customElements.define("eq-preset-dialog", kc);
//#endregion
...
var jc = class extends D {
  ...
  `;
	...
	_min() {
		return G(this.viewModel?.climate.minTemp) ? this.viewModel.climate.minTemp : 7;
	}
	_max() {
		return G(this.viewModel?.climate.maxTemp) ? this.viewModel.climate.maxTemp : 35;
	}
	_step() {
		return G(this.viewModel?.climate.targetTempStep) && this.viewModel.climate.targetTempStep > 0 ? this.viewModel.climate.targetTempStep : .5;
	}
	_stepDecimals() {
	...
	_snap(e) {
		...
		return Number(Ac(r, n, this._max()).toFixed(this._stepDecimals()));
	}
	_format(e) {
		if (!G(e)) return "--.-°";
	...
	_hasRangeControl() {
		...
		return (e === "heat_cool" || e === "auto") && (G(t?.low) || G(t?.high));
	}
	_singleValue() {
		return this._snap(G(this._temperature) ? this._temperature : this.viewModel?.climate.targetTemperature ?? this._min());
	}
	_lowValue() {
		return this._snap(G(this._low) ? this._low : this.viewModel?.climate.targetTemperatureRange?.low ?? this._min());
	}
	_highValue() {
		return this._snap(G(this._high) ? this._high : this.viewModel?.climate.targetTemperatureRange?.high ?? this._max());
	}
	_rangePercent(e) {
	...
	async _commitSingle() {
		!this.hass || !this.config || !this.viewModel || this._isDisabled() || await Ps({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
	...
	_rangePointerValue(e) {
		...
		let r = Ac((e.clientX - n.left) / n.width, 0, 1);
...
customElements.get("eq-temperature-dialog") || customElements.define("eq-temperature-dialog", jc);
//#endregion
...
customElements.get("eq-menu-dialog") || customElements.define("eq-menu-dialog", Mc);
//#endregion
...
var Nc = 60, K = [
	...
	constructor(...e) {
		super(...e), this.open = !1, this.floating = !1, this.closeOnLeave = !1, this._durationMinutes = Nc;
	}
	static {
		this.properties = {
			open: { type: Boolean },
  ...
  `;
	...
	_setDuration(e) {
		K.includes(e) && (this._durationMinutes = e);
	}
	_onDurationInput(e) {
		let t = Number(e.target.value);
		Number.isFinite(t) && this._setDuration(K[Math.round(t)] ?? Nc);
	}
	async _startBoost() {
		if (!this.hass || !this.config) return;
		let e = {
		...
		(this._hasTimedPreset() ? await Bs(e, "boost", this._durationMinutes) : await Is(e, "boost")).ok && this._dispatchClose();
	}
	async _stopBoost() {
		!this.hass || !this.config || (await Vs({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
	...
	_durationIndex(e) {
		let t = K.indexOf(e);
		return t >= 0 ? t : K.reduce((t, n, r) => Math.abs(n - e) < Math.abs(K[t] - e) ? r : t, 0);
	}
	_durationPercent(e) {
		let t = K.length - 1, n = this._durationIndex(e);
          ...
          ${i ? w`
                ...
                <div class="duration-slider-panel">
                  ...
                  <div class="duration-slider-labels">
                    <span>${this._formatDuration(K[0]).value}</span>
                    <span>${this._formatDuration(K[K.length - 1]).value}</span>
                  </div>
                </div>
              ` : E}
...
customElements.get("eq-boost-dialog") || customElements.define("eq-boost-dialog", Pc);
var Fc = {
...
function Lc(e) {
	if (typeof e != "object" || !e || Array.isArray(e)) return Ic;
	let t = {};
...
var Vc = class extends D {
  ...
  `;
	...
	_loadAttributeUnits() {
		this._attributeUnitsLoadStarted || (this._attributeUnitsLoadStarted = !0, zc().then((e) => {
	...
	_betterHistoryConfig() {
		let e = this.config?.entity, t = (e ? this.hass?.states[e] : void 0)?.attributes.current_humidity !== void 0, n = t ? void 0 : this.config?.humidity_entity, r = this.language ?? this.hass?.locale?.language, i = this.config && this.hass ? pc(this.hass, this.config) : void 0, a = `${e ?? ""}|${r ?? ""}|${i ?? ""}|${this.config?.power_entity ?? ""}|${n ?? ""}|${this.config?.temperature_entity ?? ""}|${t ? "climate-humidity" : "external-humidity"}`;
	...
	render() {
      ...
      >
        ...
        ${this.open ? w`<equinox-better-history
              ...
              .attributeUnits=${Bc(this._staticAttributeUnits)}
              .language=${this.language}
...
customElements.get("eq-history-dialog") || customElements.define("eq-history-dialog", Vc);
//#endregion
//#region src/components/eq-sensor-more-info-dialog.ts
var Hc = "var(--primary-color, #03a9f4)", Uc = "var(--equinox-boost-color, var(--accent-color, #b06cff))";
function Wc(e) {
	return typeof e == "number" && Number.isFinite(e);
}
function Gc(e) {
...
var Zc = class extends D {
  ...
  `;
	...
	_formatPercent(e) {
		return Wc(e) ? `${this._formatNumber(e, 0)}%` : "--%";
	}
	...
	_metricValueFromAttribute(e, t) {
		let n = qc(t);
		return n ? Kc(e?.attributes, n) : e?.state;
	}
	_entityMetrics(e) {
	...
	_powerAttributeMetric() {
		...
		if (e.types.includes("over_valve") || e.types.includes("over_climate_valve")) {
			let r = Xc(n, ["valve_open_percent"]) ? "valve_open_percent" : Xc(n, ["vtherm_over_valve", "valve_open_percent"]) ? ["vtherm_over_valve", "valve_open_percent"] : Xc(n, [
			...
			return Wc(e.powerValve.valveOpenPercent) ? {
		...
		if (e.types.includes("over_switch")) {
			let r = Xc(n, ["power_percent"]) ? "power_percent" : Xc(n, ["vtherm_over_switch", "power_percent"]) ? ["vtherm_over_switch", "power_percent"] : Xc(n, [
				"vtherm_over_climate",
				"valve_regulation",
				"power_percent"
			]) ? [
			...
			return Wc(e.powerValve.powerPercent) ? {
				id: "power-percent",
	...
	_betterHistoryConfig(e) {
		let t = e.map((e) => `${e.id}|${e.entityId}|${Jc(e.attribute)}|${e.unit ?? ""}|${e.scaleGroup}|${e.scalePreference ?? ""}|${e.color ?? ""}`).join(";");
	...
	render() {
      ...
      >
        ...
        <div class="content">
          ${e.length > 0 ? w`<div class="sensor-summary">${e.map((e) => this._renderMetric(e))}</div>` : w`<div class="empty">${R(this._language(), "dialog.sensor_more_info.unavailable")}</div>`}
          ${e.length > 0 ? w`
...
customElements.get("eq-sensor-more-info-dialog") || customElements.define("eq-sensor-more-info-dialog", Zc);
//#endregion
...
var el = "--", tl = /* @__PURE__ */ new Set([
  ...
  `;
	...
	_translate(e, t) {
		return this.dashboard ? $c(this.dashboard, this.language, e, t) : t ?? "";
	}
	_renderItem(e) {
	...
	_renderValue(e) {
      ...
      <article class="block" tone=${this._toneForValue(e)}>
        ...
        ${t ? w`<p class="missing">${R(this.language, "dialog.regulation.source_missing")}</p>` : E}
      </article>
    `;
	}
	_renderMetricGrid(e) {
	...
	_renderMetric(e) {
      ...
      <div class="metric" tone=${this._toneForValue(e)}>
        <span class="label">${this._translate(e.label_key, e.label)}</span>
        <span class="value">${this._formatSourceValue(e)}</span>
        ${this._sourceMissing(e.source) ? w`<span class="meta">${R(this.language, "dialog.regulation.source_missing")}</span>` : E}
      </div>
    `;
	}
	_renderStatus(e) {
		let t = gc(this._context(), e.source, e.path), n = fc(t) ? "" : String(t), r = e.map[n] ?? this._rangeStatusEntry(e, t) ?? e.fallback, i = r?.tone ?? "muted", a = r ? this._translate(r.label_key, r.label ?? n) : el, o = e.show_value ? this._formatStatusValue(e, t) : "", s = o && a !== el ? `${a} · ${o}` : a, c = r ? this._translate(r.description_key, r.description) : "";
		return w`
      <article class="block status ${e.align === "center" ? "center" : ""}" tone=${i}>
        ...
        <div>
          ...
          ${this._sourceMissing(e.source) ? w`<p class="missing">${R(this.language, "dialog.regulation.source_missing")}</p>` : E}
        </div>
      </article>
    `;
	}
	_renderProgress(e) {
      ...
      <article class="block" tone="info">
        <div class="value-row">
          <span class="label">${this._translate(e.label_key, e.label)}</span>
          <span class="value">${a === void 0 ? el : `${Math.round(a)}%`}</span>
        </div>
        ...
        ${this._sourceMissing(e.value.source) ? w`<p class="missing">${R(this.language, "dialog.regulation.source_missing")}</p>` : E}
      </article>
    `;
	}
	_renderHistory(e) {
	...
	_renderAction(e) {
      ...
      <article class="block action-block" tone=${this._isDestructiveAction(e) ? "warning" : "info"}>
        ...
        ${r ? w`<p class="missing">${R(this.language, "dialog.regulation.action_locked")}</p>` : E}
        ${this._actionError === n ? w`<p class="missing" role="alert">${R(this.language, "dialog.regulation.action_failed")}</p>` : E}
      </article>
    `;
	}
	...
	_resolveActionValue(e) {
		...
		switch (e) {
			...
			case "$diagnostic_entity": return this.config && this.hass ? pc(this.hass, this.config) : void 0;
	...
	_isDestructiveAction(e) {
		return tl.has(e.service);
	}
	_isThermostatLocked() {
		return this.viewModel?.vt?.lock.isUserLocked === !0 || gc(this._context(), "climate", "lock_manager/is_locked") === !0;
	}
	_actionKey(e) {
	...
	_betterHistorySeries(e) {
		...
		return t ? [{
			entity: t,
			attribute: e.attribute ? uc(e.attribute) : void 0,
	...
	_historyConfigCacheKey(e) {
		return JSON.stringify({
			...
			diagnostic: this.config && this.hass ? pc(this.hass, this.config) ?? "" : "",
	...
	_formatSourceValue(e) {
		let t = gc(this._context(), e.source, e.path), n = this._formatPrimitive(t, e.digits, e.fallback), r = this._translate(e.unit_key, e.unit);
		return n === el || !r ? n : `${n} ${r}`;
	}
	_formatPrimitive(e, t, n = el) {
		return fc(e) ? n || el : typeof e == "number" ? Number.isFinite(e) ? e.toFixed(Math.max(0, t ?? 0)) : n || el : typeof e == "boolean" ? e ? "true" : "false" : String(e);
	}
	...
	_toneForValue(e) {
		let t = gc(this._context(), e.source, e.path);
		return e.tone_map?.[String(t)] ?? "muted";
	}
	_readValueRef(e) {
		return gc(this._context(), e.source, e.path);
	}
	_asNumber(e) {
		if (typeof e == "number") return Number.isFinite(e) ? e : void 0;
		if (typeof e != "string" || e.trim() === "") return;
	...
	_sourceMissing(e) {
		return !this.hass || !this.config || mc(this.hass, this.config)[e] === void 0;
	}
	_conditionMatches(e) {
	...
	_readConditionVariable(e) {
		...
		if (!(!n || ![
			...
			"temperature",
			"config"
		].includes(n))) return gc(this._context(), n, t.slice(1));
	}
...
customElements.get("eq-regulation-renderer") || customElements.define("eq-regulation-renderer", nl);
//#endregion
//#region src/components/eq-regulation-dialog.ts
var rl = class extends D {
	constructor(...e) {
  ...
  `;
	...
	_renderContent() {
		...
		if (!this.hass || !this.config) return w`<div class="state" role="status">${R(this.language, "dialog.regulation.loading")}</div>`;
		if (this.loadResult?.status === "unavailable") return w`<div class="state" role="status">${R(this.language, "dialog.regulation.unavailable")}</div>`;
		if (this.loadResult?.status === "error") {
			...
			return w`<div class="state" role="alert">${R(this.language, e)}</div>`;
		}
		if (!this.dashboard || this.dashboard.kind !== "regulation-dashboard" || this.dashboard.sections.length === 0) return w`<div class="state" role="alert">${R(this.language, "dialog.regulation.invalid")}</div>`;
      ...
      <div class="layout" ?single-section=${this.dashboard.sections.length === 1}>
        ${this.dashboard.sections.length > 1 ? w`
			...
			let n = $c(this.dashboard, this.language, t.title_key, t.title || t.id);
			return w`
                    <button
	...
	_dialogTitle() {
		...
		let t = $c(this.dashboard, this.language, this.dashboard.title_key, this.dashboard.title);
		if (this._isMobile()) {
			let n = this.dashboard.sections.find((e) => e.id === this._activeSectionId());
			return (n ? $c(this.dashboard, this.language, n.title_key, n.title || n.id) : "") || (t ? `${e} - ${t}` : e);
		}
		return t ? `${e} - ${t}` : e;
	}
	_activeSectionId() {
...
customElements.get("eq-regulation-dialog") || customElements.define("eq-regulation-dialog", rl);
//#endregion
...
var il = 4, al = [
	...
	constructor(...e) {
		super(...e), this.open = !1, this.entityId = "", this.isLocking = !0, this._code = "", this._error = !1, this._loading = !1, this._onKeyDown = (e) => {
			this.open && (e.key >= "0" && e.key <= "9" ? this._pressDigit(e.key) : e.key === "Backspace" ? this._pressBackspace() : e.key === "Escape" ? this._cancel() : e.key === "Enter" && this._code.length === il && this._validate());
		};
	}
	static {
		this.properties = {
  ...
  `;
	...
	_renderKey(e) {
      ...
      <button
        class="key"
        ?disabled=${this._loading || this._code.length >= il}
	...
	_pressDigit(e) {
		this._loading || this._code.length >= il || (this._error = !1, this._code += e, this._code.length === il && this._validate());
	}
	_pressBackspace() {
		this._loading || this._code.length === 0 || (this._error = !1, this._code = this._code.slice(0, -1));
	}
	async _validate() {
		if (this._loading || !this.hass || this._code.length < il) return;
		this._loading = !0;
...
customElements.get("eq-lock-dialog") || customElements.define("eq-lock-dialog", ol);
//#endregion
//#region src/components/eq-main-card.ts
var sl = "equinox", cl = /* @__PURE__ */ new Set(/* @__PURE__ */ "primary.accent.red.pink.purple.deep-purple.indigo.blue.light-blue.cyan.teal.green.light-green.lime.yellow.amber.orange.deep-orange.brown.light-grey.grey.dark-grey.blue-grey.black.white.primary-text.secondary-text.disabled".split(".")), ll = [
	{
		key: "hasOverpowering",
...
function gl(e, t) {
	...
	let n = ml(e);
	if (n) return hl(n) > .42 ? "#111418" : "#ffffff";
}
function _l(e) {
	if (e == null || e === "") return;
	let t = Number(e);
...
var vl = class extends D {
	...
	_browserHistoryEntry(e = window.history.state) {
		let t = typeof e == "object" && e ? e[sl] : void 0;
		if (typeof t != "object" || !t) return;
		let n = t;
	...
	_clearBrowserHistoryState() {
		...
		delete e[sl], window.history.replaceState(e, "", window.location.href);
	}
	...
	_regulationLoadCacheKey() {
		if (!this.hass || !this.config) return;
		let e = bc(this.hass, this.config);
	...
	_ensureRegulationDashboard() {
		...
		let e = bc(this.hass, this.config), t = this._regulationLoadCacheKey();
		...
		let n = tc(e).then((e) => (this._regulationLoadKey === t && (this._regulationLoadResult = e, this._regulationLoadPromise = void 0, e.status === "loaded" && !this._regulationActiveSectionId && (this._regulationActiveSectionId = e.dashboard.sections[0]?.id)), e));
	...
	_cardStyle() {
		let e = pl(this.config?.card_background_color), t = _l(this.config?.card_background_opacity), n = gl(this.config?.card_background_color, t), r = e && t !== void 0 ? `color-mix(in srgb, ${e} ${t}%, transparent)` : e || (t === void 0 ? void 0 : `color-mix(in srgb, var(--equinox-card-bg) ${t}%, transparent)`), i = [];
	...
	_renderThinLayout() {
		let e = q(this.viewModel?.climate.currentHumidity), t = this._thinExtraSelectorCount();
		return w`
      <div
        class="thin-layout"
        ?has-extra=${t > 0}
	...
	_renderThinSummaryRow() {
		let e = this.viewModel?.climate.currentHumidity, t = q(e), n = q(this.viewModel?.climate.currentTemperature), r = !this.config?.hide_lock_button && this.viewModel?.vt?.lock.isConfigured === !0, i = this.viewModel?.vt?.lock.isLocked ? R(this._language(), "main.lock.locked") : R(this._language(), "main.lock.unlocked");
		return w`
	...
	_renderThinExtraSelectors() {
		let e = this._shouldShowFanControl() ? this._renderThinFanButton() : E, t = this._shouldShowSwingControl() ? this._renderThinSwingButton() : E;
		return e === E && t === E ? E : w`<div class="thin-selectors thin-extra-selectors">${e}${t}</div>`;
	}
	...
	_hvacActionIcon(e, t) {
		...
		if (n === "preheating" || n === "heat" || n === "heating") return {
			icon: "mdi:radiator",
			tone: W(n === "preheating" ? "preheating" : "heating")
		};
		...
		let r = e ? dl[e] : void 0, i = r?.icon || (t ? this._hvacIcon(t) : "");
		return i ? {
			icon: i,
	...
	_renderEvents() {
		...
		if (!e) return [];
		let n = new Set(ll.filter((e) => e.key === "hasTimer").flatMap((e) => e.messageKeys ?? [])), r = t.map((e) => {
	...
	_renderSensorFocus() {
		let e = this.viewModel?.climate.currentHumidity, t = q(e), n = q(this.viewModel?.climate.currentTemperature);
		return w`
	...
	_hvacLabel(e) {
		return !e || this.viewModel?.climate.availability !== "available" ? R(this._language(), "main.status.unavailable") : ds({
			config: this.config,
			language: this._language(),
			family: "hvac",
			mode: e
	...
	_setPresetMode(e) {
		!this.hass || !this.config || !this.viewModel || Is({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
		}, e);
...
customElements.get("eq-main-card") || customElements.define("eq-main-card", vl);
//#endregion
//#region src/data/format.ts
var yl = /* @__PURE__ */ new Set(["unknown", "unavailable"]);
function bl(e) {
	return e == null || typeof e == "string" && yl.has(e);
}
function J(e) {
	if (!(bl(e) || typeof e != "string" || e.trim() === "")) return e;
}
function Y(e) {
	if (bl(e)) return;
	if (typeof e == "number") return Number.isFinite(e) ? e : void 0;
...
function El(e, t) {
	let n = Sl(Q(e, ["specific_states", "messages"]));
...
function Ol(e, t) {
	let n = Dl(e)?.toLowerCase(), r = J(Q(e, ["specific_states", "regulation_diagnostics"])), i = r ? t.states[r]?.attributes : void 0, a = X(J(Q(i, ["control", "phase"])), J(Q(e, [
		"specific_states",
		"smartpi",
		"control",
		"phase"
...
function kl(e, t, n) {
	let r = n.attributes, i = Z(r.specific_states), a = Tl(r);
	if (!(a.length > 0 || i !== void 0 || Z(r.configuration) !== void 0)) return;
	let o = wl(r), s = X(Y(Q(r, ["vtherm_over_switch", "power_percent"])), Y(Q(r, [
		"vtherm_over_climate",
		"valve_regulation",
		"power_percent"
		...
		"valve_regulation",
		"valve_open_percent"
	])), Y(r.valve_open_percent)), l = Q(r, ["timed_preset_manager", "is_active"]) === !0, u = X(Q(r, ["lock_manager", "is_locked"]) === !0 || void 0, Q(r, ["specific_states", "is_locked"]) === !0 || void 0) === !0, d = El(r, t), f = J(Q(r, ["vtherm_over_climate", "auto_fan_mode"])), p = J(Q(r, ["vtherm_over_climate", "current_auto_fan_mode"])), m = e.power_entity ? t.states[e.power_entity] : void 0, h = J(Q(r, ["requested_state", "hvac_mode"]));
	return {
		isVt: !0,
		types: a,
		configuration: {
...
function Il(e, t, n) {
	let r = n.attributes, i = Pl(e, t), a = X(bl(n.state) ? void 0 : n.state, J(r.hvac_mode), J(jl(r, ["current_state", "hvac_mode"]))), o = X(J(r.preset_mode), J(jl(r, ["current_state", "preset"]))), s = a === "cool" && o === "frost" ? "none" : o;
	return {
		...
		targetTemperature: X(Y(r.temperature), Y(jl(r, ["current_state", "target_temperature"]))),
		...
		hvacModes: xl(r.hvac_modes),
		presetModes: xl(r.preset_modes),
		presetMode: s,
		fanMode: J(r.fan_mode),
		fanModes: xl(r.fan_modes),
		swingMode: J(r.swing_mode),
		swingModes: xl(r.swing_modes),
		swingHorizontalMode: J(r.swing_horizontal_mode),
		swingHorizontalModes: xl(r.swing_horizontal_modes),
		minTemp: Y(r.min_temp),
		maxTemp: Y(r.max_temp),
		targetTempStep: X(Y(r.target_temp_step), Y(jl(r, ["configuration", "target_temperature_step"])), .5),
...
function Gl(e) {
	...
	if (!zl(vs, t.theme)) return {
		config: t,
		error: "invalid_theme"
	};
	if (!zl(ys, t.display_mode)) return {
		config: t,
		error: "invalid_display_mode"
	};
	if (!zl(bs, t.primary_display)) return {
		config: t,
		error: "invalid_primary_display"
	};
	if (t.setpoint_selector === void 0 && typeof t.use_temperature_popup == "boolean" && (t.setpoint_selector = t.use_temperature_popup ? "slider" : "buttons"), delete t.use_temperature_popup, !zl(xs, t.setpoint_selector)) return {
		config: t,
		error: "invalid_setpoint_selector"
	};
	if (!zl(Ss, t.additional_dashboards)) return {
		config: t,
		error: "invalid_additional_dashboards"
	};
	if (!zl(Cs, t.state_icons_layout)) return {
		config: t,
	...
	let o = fs(t.mode_customizations);
...
var Yl = class extends D {
  ...
  `;
	...
	render() {
		...
		return this.hass && !n ? this._renderMessage(R(e, "card.entity_not_found", { entity: t }), !0) : w`
      <eq-main-card
        .hass=${this.hass}
...
customElements.get("equinox-card") || customElements.define(Po, Yl), window.customCards = window.customCards ?? [];
