...
var ne = globalThis, re = (e) => e, S = ne.trustedTypes, ie = S ? S.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ae = "$lit$", C = `lit$${Math.random().toFixed(9).slice(2)}$`, oe = "?" + C, se = `<${oe}>`, ce = document, le = () => ce.createComment(""), ue = (e) => e === null || typeof e != "object" && typeof e != "function", de = Array.isArray, fe = (e) => de(e) || typeof e?.[Symbol.iterator] == "function", pe = "[ 	\n\f\r]", me = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, he = /-->/g, ge = />/g, _e = RegExp(`>|${pe}(?:([^\\s"'>=/]+)(${pe}*=${pe}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), ve = /'/g, ye = /"/g, be = /^(?:script|style|textarea|title)$/i, xe = (e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}), w = xe(1), T = xe(2), Se = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), Ce = /* @__PURE__ */ new WeakMap(), we = ce.createTreeWalker(ce, 129);
function Te(e, t) {
...
var Ee = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		a += o === me ? n + se : l >= 0 ? (r.push(s), n.slice(0, l) + ae + n.slice(l) + C + d) : n + C + (l === -2 ? t : d);
	}
...
var ke = class {
	...
	_(e) {
		this._$AH !== E && ue(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ce.createTextNode(e)), this._$AH = e;
	}
	$(e) {
...
}, Ie = ne.litHtmlPolyfillSupport;
Ie?.(De, Ae), (ne.litHtmlVersions ??= []).push("3.3.3");
var Le = (e, t, n) => {
	...
	return i._$AI(e), i;
}, Re = globalThis, D = class extends x {
	constructor() {
...
var He = 1e4, Ue = class extends Error {
	result;
	cause;
	constructor(e, t) {
		super(e.missing.length > 0 ? `Unable to load Home Assistant components: ${e.missing.join(", ")}` : "Unable to load Home Assistant components"), this.name = "HaComponentsLoadError", this.result = Ye(e), this.cause = t;
	}
}, We = [
	"ha-form",
	"ha-icon",
...
function Ze(e) {
	return typeof e == "number" && Number.isFinite(e) && e > 0 ? e : He;
}
function Qe(e) {
...
function et(e, t, n) {
	let r, i = Promise.resolve(e).catch((e) => {
		throw $e(`Failed while ${n}`, e);
	}), a = new Promise((e, i) => {
		r = setTimeout(() => {
			i($e(`Timed out while ${n}`));
		}, t);
	});
...
function tt() {
	return typeof window < "u" && typeof document < "u" && nt();
}
function nt() {
...
function it(e) {
	return Ge[e] ?? ["config-automation"];
}
function at(e) {
	let t = /* @__PURE__ */ new Set();
	for (let n of e) for (let e of it(n)) t.add(e);
	return [...t];
}
function ot(e, t, n) {
	let r = e?.routes?.[t]?.load;
	if (typeof r != "function") throw $e(`No load() route for ${t} in ${n}`);
	return r;
}
async function st(e, t, n) {
	if (!tt()) throw $e("A DOM environment is required to load Home Assistant components");
	await et(customElements.whenDefined("partial-panel-resolver"), n, "waiting for partial-panel-resolver");
	let r = document.createElement("partial-panel-resolver");
	if (!r) throw $e("Failed to create partial-panel-resolver");
	let i = { [t]: {
		url_path: t,
		component_name: e
	} }, a;
	...
	} else throw $e("partial-panel-resolver exposes neither _getRoutes() nor _updateRoutes()");
	await et(ot(a, t, "partial-panel-resolver").call(a?.routes?.[t]), n, `loading ${e} panel`);
}
function ct(e) {
	if (Je) return Je;
	let t;
	return t = (async () => {
		await st("config", "tmp", e), await et(customElements.whenDefined("ha-panel-config"), e, "waiting for ha-panel-config");
		let t = document.createElement("ha-panel-config");
		if (!t) throw $e("Failed to create ha-panel-config");
		if (!t.routerOptions?.routes) throw $e("ha-panel-config exposes no routes");
		return t.routerOptions;
	})().catch((e) => {
		throw Je === t && (Je = void 0), e;
	}), Je = t, t;
}
async function lt(e, t) {
	let n = await ct(t);
	await et(ot(n, e, "ha-panel-config").call(n.routes?.[e]), t, `loading ${e} route`);
}
function ut(e) {
	return st("history", "history", e);
}
function dt(e) {
	return st("media-browser", "media-browser", e);
}
var ft = {
	"config-automation": (e) => lt("automation", e),
	history: ut,
	"config-general": (e) => lt("general", e),
	"config-labels": (e) => lt("labels", e),
	"media-browser": dt
};
function pt(e, t) {
	let n = qe.get(e);
	if (n) return n;
	let r;
	return r = ft[e](t).catch((t) => {
		throw qe.get(e) === r && qe.delete(e), t;
	}), qe.set(e, r), r;
}
function mt(e, t, n) {
	let r = e.filter((e) => !rt(e)), i = new Set(t);
	return {
		requested: [...e],
		alreadyDefined: [...t],
...
function ht(e, t, n) {
	for (let [r, i] of t) (n === "card" || e.some((e) => it(e).includes(r))) && qe.get(r) === i && qe.delete(r);
}
async function gt(e, t) {
	let n = Xe(e), r = [], i = nt() ? n.filter(rt) : [];
	if (i.length === n.length) return mt(n, i, r);
	if (!tt()) {
		let e = new Set(i);
		throw new Ue({
			requested: [...n],
		...
		}, $e("A DOM environment is required to load Home Assistant components"));
	}
	let a = Ze(t?.timeoutMs), o = Qe(t?.discovery), s = /* @__PURE__ */ new Map(), c;
	try {
		for (let e of at(n.filter((e) => !i.includes(e)))) {
			if (!n.filter((e) => !rt(e)).some((t) => it(t).includes(e))) continue;
			r.push(e);
			let t = pt(e, a);
			s.set(e, t), await t;
		}
		if (o === "card") for (let e of Ke) {
			if (s.has(e)) continue;
			if (n.every(rt)) break;
			r.push(e);
			let t = pt(e, a);
	...
	let l = mt(n, i, r);
	if (c !== void 0 || l.missing.length > 0) throw ht(l.missing, s, o), new Ue(l, c);
	return l;
}
//#endregion
//#region node_modules/@kipk/ha-better-history/dist/all.js
var _t = /* @__PURE__ */ new Set(["unknown", "unavailable"]);
function vt(e) {
	return e == null || typeof e == "string" && _t.has(e);
}
function yt(e) {
	if (!(vt(e) || typeof e != "string" || e.trim() === "")) return e;
}
function bt(e) {
	if (vt(e)) return;
...
var Ct = 6e4, wt = 3, Tt = 350, Et = 216e5, Dt = 36e5, Ot = 432e5, kt = 2500, At = 8e3, jt = 15e3, Mt = 300, Nt = 700, Pt = 1100, Ft = 80;
function It(e) {
...
function Wt(e) {
	...
	let n = Vt(e).toLowerCase(), r = `${Ut(e)} ${n}`;
...
function Xt(e) {
	let t = Number(e.state), n = e.attributes.unit_of_measurement, r = e.attributes.state_class, i = typeof r == "string" && r.trim() !== "" || typeof n == "string" && n.trim() !== "", a = vt(e.state) && i ? "number" : Yt(Number.isFinite(t) ? t : e.state);
	if (a) return {
...
function Zt(e, t, n) {
	let r = zt(e.attributes, t), i = Yt(typeof r == "string" && Number.isFinite(Number(r)) ? Number(r) : r);
	if (i) return {
...
function Qt(e, t) {
	return t === "number" ? bt(e) : t === "boolean" ? typeof e == "boolean" ? e : void 0 : yt(e);
}
function $t(e, t) {
	let n = e.attributes ?? e.a ?? {};
	return Qt(t.kind === "entity_state" ? e.state ?? e.s : zt(n, t.path ?? []), t.valueType);
}
function en(e) {
...
function rn(e, t, n = Date.now()) {
	...
	}, a = $t(i, t), o = en(i), s = Number.isFinite(o) ? o : n;
...
var on = class {
	...
	hasCoverage(e, t, n, r) {
		...
		return i ? cn(r === "full" ? i.fullCoverage : [...i.stateCoverage, ...i.fullCoverage], t.getTime(), n.getTime()) : !1;
	}
	missingIntervals(e, t, n, r) {
		let i = this._entities.get(e);
		return un(i ? r === "full" ? i.fullCoverage : [...i.stateCoverage, ...i.fullCoverage] : [], t.getTime(), n.getTime()).map((e) => ({
	...
	integrate(e, t, n, r, i) {
		...
		a.states = dn([...a.states, ...t]), a.stateCoverage = sn([...a.stateCoverage, {
			startTime: n.getTime(),
			endTime: r.getTime()
		}]), i === "full" && (a.fullCoverage = sn([...a.fullCoverage, {
			startTime: n.getTime(),
			endTime: r.getTime()
	...
	buildSeries(e, t, n, r) {
		...
		return gn(e, this._entities.get(e.entityId)?.states ?? [], t, n, new Date(a));
	}
	coverageEnd(e, t, n, r) {
		let i = this._entities.get(e);
		return i ? ln(r === "full" ? i.fullCoverage : [...i.stateCoverage, ...i.fullCoverage], t.getTime(), n.getTime()) : n.getTime();
	}
};
function sn(e) {
...
function ln(e, t, n) {
	if (n <= t) return n;
	let r = t;
	for (let t of sn(e)) if (!(t.endTime < r)) {
...
function un(e, t, n) {
	if (n <= t) return [];
	let r = [], i = t;
	for (let t of sn(e)) if (!(t.endTime <= i) && (t.startTime > i + 1 && r.push({
		startTime: i,
...
function fn(e, t) {
	let n = t.normalizeDurationMs + t.mergeDurationMs + t.buildDurationMs, r = t.stateCount >= jt || t.requestDurationMs >= Pt, i = r || t.stateCount >= At || t.requestDurationMs >= Nt || n >= Ft, a = t.stateCount <= kt && t.requestDurationMs <= Mt && n <= Ft / 2;
	return i && e > Dt ? {
		nextChunkMs: Math.max(Dt, Math.floor(e / (r ? 4 : 2))),
		reason: "decrease"
	} : a && e < Ot ? {
		nextChunkMs: Math.min(Ot, e * 2),
		reason: "increase"
	} : {
		nextChunkMs: e,
		reason: "keep"
...
async function mn(e, t) {
	...
	for (;;) {
		...
		try {
			...
			let i = Wt(e), a = i && n < t.maxAttempts && !t.isCancelled?.();
			if (t.onPerformance?.({
			...
			await Kt(Gt(n, t.retryBaseDelayMs)), n += 1;
		}
	}
}
async function hn(e, t, n, r, i, a, o = {}) {
	if (!e.callWS && !e.callApi) throw Error("Home Assistant history API is unavailable");
	let s = [...new Set(t.map((e) => e.entityId))], c = new Set(t.filter((e) => e.kind === "entity_state").map((e) => e.entityId)), l = new Set(t.filter((e) => e.kind === "entity_attribute").map((e) => e.entityId)), u = s.filter((e) => c.has(e)), d = s.filter((e) => l.has(e)), f = o.accumulator ?? new on(), p = [], m = Math.max(1, Math.floor(o.chunkTimeoutMs ?? Ct)), h = Math.max(1, Math.floor(o.maxChunkAttempts ?? wt)), g = Math.max(0, Math.floor(o.chunkRetryBaseDelayMs ?? Tt)), _ = (e, t) => mn(t, {
		taskId: e,
		timeoutMs: m,
		maxAttempts: h,
		retryBaseDelayMs: g,
	...
	let ee = b.reduce((e, t) => {
		...
		return e + Math.max(1, Math.ceil(n / Et));
		...
		await qt();
		let d = A(), p = nn(c, s.entityIds), m = A() - d, h = [...p.values()].reduce((e, t) => e + t.length, 0);
		a?.({
			event: "history.batch",
			details: {
				batchIndex: u,
	...
	for (let t of v.values()) {
		...
		p.push({
			...
			run: () => _(i, () => pn(e, r, t.start, t.end, t.minimalResponse, t.noAttributes, t.significantChangesOnly))
		});
	}
	a?.({
		event: "history.start",
		details: {
			...
			batchCount: te,
			attributeChunkHours: Et / 36e5,
			minAttributeChunkHours: Dt / 36e5,
			maxAttributeChunkHours: Ot / 36e5,
	...
	for (let t of b) {
		...
		for (let r = t.start.getTime(); r < t.end.getTime() && !o.isCancelled?.();) {
			...
			let l = A(), u = await _(c, () => pn(e, [t.entityId], i, o, !1, !1, !1)), d = A() - l;
			ie += 1, a?.({
...
function gn(e, t, n, r, i) {
	...
	return {
		source: e,
		points: It(a.length > 0 ? tn(a, r, i) : an(n, e, r, i))
	};
}
var _n = 6e4, vn = 48;
function yn(e) {
...
var Tn = class {
	...
	_hasActiveEntityLoad(e, t) {
		return (e.activeEntityLoads.get(xn(t)) ?? 0) > 0;
	}
	_beginLoad(e, t) {
		e.activeLoads += 1;
		for (let n of t) {
	...
	_completeLoad(e, t) {
		...
		for (let n of t) {
			let t = xn(n), r = Math.max(0, (e.activeEntityLoads.get(t) ?? 0) - 1);
	...
	_requestProgressUpdate(e) {
		...
		let t = A() - this._lastProgressUpdateMs, n = Math.max(0, vn - t);
		setTimeout(() => {
	...
	fetch(e, t, n, r) {
		let i = `${St(t)}|${n.getTime()}|${r.getTime()}`;
		...
		this.series = [], this.changedSourceIds = /* @__PURE__ */ new Set(), this.loading = !0, this.error = "", this._beginLoad(a, t), this.debugPerformance && j(this.debugPerformance, "controller.fetch_start", {
			sessionId: a.id,
			sourceCount: t.length,
			rangeHours: Math.round((r.getTime() - n.getTime()) / 36e3) / 100
		}), this.host.requestUpdate(), hn(e, a.sources, n, r, (t, i) => {
			if (!this._isCurrentSession(a)) return;
			let o = A(), s = this._availableSessionSeries(a, e, n, r, t);
			...
			this._requestProgressUpdate(a), this.debugPerformance && j(this.debugPerformance, "controller.progress_update", {
				...
				updateDurationMs: Math.round(A() - o)
			});
			...
			this._isCurrentSession(a) && yn(() => {
				...
				Sn(this.series, l) || (this.series = l), this.changedSourceIds = /* @__PURE__ */ new Set();
			...
			if (this._isCurrentSession(a)) {
				...
				this.error = bn(e), this._completeLoad(a, t), this.host.requestUpdate(), this.debugPerformance && j(this.debugPerformance, "controller.fetch_error", {
					sessionId: a.id,
					totalDurationMs: Math.round(A() - o),
					error: this.error
				});
	...
	setImportedSeries(e, t, n) {
		this._cancelSession(), this.series = e, this.changedSourceIds = new Set(e.map((e) => e.source.id)), this.loading = !1, this.error = "", this._prevKey = `${St(e.map((e) => e.source))}|${t.getTime()}|${n.getTime()}`, this.host.requestUpdate();
	}
	setError(e) {
	...
	addSources(e, t, n, r) {
		...
		let c = o.filter((e) => !this._hasActiveEntityLoad(i, e)), l = new Set(c.map((e) => e.id)), u = i.sources.filter((e) => l.has(e.id) || !s.has(xn(e))), d = A();
		...
		this.loading = !0, this._beginLoad(i, c), this.debugPerformance && j(this.debugPerformance, "controller.add_sources_start", {
			...
			existingSourceCount: this.series.length,
			rangeHours: Math.round((r.getTime() - n.getTime()) / 36e3) / 100
		}), this.host.requestUpdate(), hn(e, u, n, r, (t, a) => {
			if (!this._isCurrentSession(i)) return;
			let o = A(), s = this._availableSessionSeries(i, e, n, r, t);
			...
			this._requestProgressUpdate(i), this.debugPerformance && j(this.debugPerformance, "controller.add_sources_progress", {
				...
				sourceCount: t.length,
				pointCount: t.reduce((e, t) => e + t.points.length, 0),
				mergeDurationMs: Math.round(A() - o)
			});
		}, this.debugPerformance ? (e) => {
			j(this.debugPerformance, e.event, e.details);
		} : void 0, {
			...
			this._isCurrentSession(i) && yn(() => {
				if (!this._isCurrentSession(i)) return;
				let a = A(), o = this._availableSessionSeries(i, e, n, r, t), s = this._mergeSeries(this.series, o);
				Sn(this.series, s) || (this.series = s), this.changedSourceIds = /* @__PURE__ */ new Set();
			...
			if (this._isCurrentSession(i)) {
				...
				this.error = bn(e), this._completeLoad(i, c), this.host.requestUpdate(), this.debugPerformance && j(this.debugPerformance, "controller.add_sources_error", {
					sessionId: i.id,
					totalDurationMs: Math.round(A() - d),
					error: this.error
				});
	...
	removeSources(e) {
		...
		this._prevKey = `${St(this.series.map((e) => e.source))}|`, this.host.requestUpdate();
	}
}, En = [
	"#ff9800",
	"#42a5f5",
	...
	temperature: "#ff9800"
}, On = new Set(Object.values(Dn)), kn = En.filter((e) => !On.has(e)), An = /* @__PURE__ */ new Set([
	"primary",
	"accent",
	"red",
	"pink",
...
function Pn(e) {
	...
	if (An.has(t)) return `var(--${t}-color, ${n !== t && Nn(n) ? n : t})`;
	if (Nn(t)) return t;
...
function In(e, t, n) {
	let r = Pn(e);
	if (r && !t.has(Mn(r))) return r;
	let i = [
		...kn.slice(n % kn.length),
		...kn.slice(0, n % kn.length),
		...En
	];
	for (let e of i) if (!t.has(Mn(e))) return e;
	let a = n, o = Fn(a);
	for (; t.has(Mn(o));) a += 1, o = Fn(a);
	return o;
}
function Ln(e) {
	return Mn(e);
...
function Un(e, t, n = 5) {
	...
	let r = Math.abs(t - e);
	if (r < 1e-10) return [e];
	let i = Wn(r / (Math.max(n, 2) - 1)), a = Math.floor(e / i) * i, o = Math.ceil(t / i) * i, s = i * 1e-8, c = [];
	for (let e = a; e <= o + s; e += i) c.push(Gn(e, i));
	return c;
}
function Wn(e) {
	if (e <= 0) return 1;
...
function tr(e, t) {
	let n = Math.abs(er(Qn(e)) - er(Qn(t))), r = Math.abs(er($n(e)) - er($n(t))), i = nr(e.unit) === nr(t.unit) ? 0 : 2;
	return n + r * .6 + i;
}
function nr(e) {
	return Bn(e);
...
function rr(e) {
	return e.length > 0 && e.every((e) => M(e.unit));
}
function ir(e) {
	if (e.length < 2) return !1;
	let t = Math.min(...e.map((e) => e.min)), n = Math.max(...e.map((e) => e.max)), r = Math.max(n - t, 1e-9), i = e.map((e) => e.max - e.min).filter((e) => e > 1e-6);
	if (i.length < 2) return !1;
	let a = Math.min(...i), o = Math.max(...i), s = i.find((e) => e / r <= Yn);
	return s !== void 0 && r / s >= Zn && (o / Math.max(a, 1e-9) >= Xn || r / a >= Xn);
}
function ar(e) {
...
function or(e, t) {
	...
	if (n.length > 0 || !t || !ir(e)) return [e, []];
	let [a, o] = ar(e), s = [], c = [];
	for (let t of e) t.id === a.id ? s.push(t) : t.id === o.id ? c.push(t) : tr(t, a) <= tr(t, o) ? s.push(t) : c.push(t);
	return [s, c];
}
function sr(e, t) {
	let n = cr(e);
	return n.length >= 2 ? [n[0].series, n[1].series] : or(e, t);
}
function cr(e) {
	let t = [];
	for (let n of e) {
		let e = nr(n.unit), r = t.find((t) => t.unit === e);
...
function ur(e, t, n, r, i) {
	let a = Math.min(...r.map((e) => e.min)), o = Math.max(...r.map((e) => e.max)), s = Math.max(...r.map((e) => e.precision)), c = qn(a, o, s), l = Un(c.min, c.max);
	return {
...
function dr(e, t = {}) {
	...
	for (let [t, n] of e.entries()) {
		...
		let e = n.points.map((e) => Number(e.value)).filter((e) => Number.isFinite(e)), i = n.scaleMode === "manual" && n.scaleMin !== void 0 ? n.scaleMin : 0, a = n.scaleMode === "manual" && n.scaleMax !== void 0 ? n.scaleMax : 1, o = n.valueType === "boolean" ? 0 : e.length > 0 ? Math.min(...e) : Math.min(i, a), s = n.valueType === "boolean" ? 1 : e.length > 0 ? Math.max(...e) : Math.max(i, a), c = n.valueType === "boolean" || e.length === 0 ? 0 : Math.max(...e.map((e) => Vn(e))), l = n.valueType === "boolean" ? "group:boolean" : n.scaleGroupKey, u = r.find((e) => e.key === l);
		u || (u = {
			key: l,
			series: []
	...
	let i = 0;
	return r.flatMap((e) => (e.key === "group:boolean" ? [e.series] : lr(e.series)).flatMap((t, r) => {
		let a = r === 0 ? e.key : `${e.key}::unit-graph:${r + 1}`, o = n && e.key !== "group:temperature" && !rr(t), [s, c] = e.key === "group:boolean" ? [t, []] : sr(t, o), l = 28 + i++ * 214, u = ur(a, e.key, "left", s, l);
		return c.length > 0 ? [u, ur(a, e.key, "right", c, l)] : [u];
	}));
}
function fr(e, t, n, r) {
	let i = e.map((e) => ({
...
function _r(e, t, n) {
	...
	return s.length === 0 ? [] : vr(a.points, n).filter((e) => e.value === "heating").reduce((e, t) => {
		let n = e[e.length - 1];
		...
		let c = o.top + o.height, l = [
			`${pr(e, n).toFixed(1)},${c.toFixed(1)}`,
			...i.map((e) => `${pr(e.time, n).toFixed(1)},${mr(e.value, o).toFixed(1)}`),
			`${pr(t, n).toFixed(1)},${c.toFixed(1)}`
		].join(" ");
		return [{
			id: `${a.id}:heat:${r}`,
			points: l
...
function wr(e, t, n, r) {
	...
	let i = String(e);
	return Cr.has(i.toLowerCase()) ? "var(--better-history-muted-color, var(--secondary-text-color, #888))" : (n.has(i) || n.set(i, En[(r + n.size) % En.length]), n.get(i));
}
function Tr(e, t) {
...
function Er(e, t, n, r) {
	return e.flatMap((e) => {
		...
		let i = br(e, t);
		if (!i) return [];
		let a = fr(Dr(e.points, n, e.lineMode, r), n, 40, 640), { points: o, pathLength: s } = e.lineMode === "line" ? Fr(a, n, i) : Pr(a, n, i);
		return [{
			id: e.id,
			color: e.color,
			points: o,
...
function jr(e, t, n, r) {
	return e.flatMap((e) => {
		...
		return Sr(e, n, r.extendColumnToEnd).flatMap((t, r) => {
			...
			let s = N(t.start, n), c = N(t.end, n), l = yr(o, i), u = Math.max(c - s, 1);
			return [{
				id: `${e.id}:${r}`,
				x: s,
				y: Math.min(l, a),
...
function Pr(e, t, n) {
	...
	if (e.length === 1) return {
		points: `${N(e[0].time, t).toFixed(1)},${yr(e[0].value, n).toFixed(1)}`,
		pathLength: 0
	};
	let r = [], i = 0;
	for (let a = 0; a < e.length - 1; a++) {
		let o = e[a], s = e[a + 1], c = N(o.time, t), l = yr(o.value, n), u = N(s.time, t), d = yr(s.value, n);
...
function Fr(e, t, n) {
	...
	return {
		points: e.map((e) => {
			let a = N(e.time, t), o = yr(e.value, n);
...
function Xr(e, t, n, r = !1, i = 12, a = !0, o = !0) {
	let s = { extendStairToEnd: a }, c = { extendColumnToEnd: a }, l = dr(Yr(e, t, n), { autoScaleSplit: o }), u = new Set(l.map((e) => e.graphKey)).size, d = Jn(u), f = e.filter((e) => e.valueType !== "number" && e.valueType !== "boolean").length, p = Hr(n.start, n.end, i), m = n.end - n.start;
	return {
		allSeries: e,
		visibleSeries: t,
		timeBounds: n,
...
function Qr(e, t, n) {
	return e.map((e) => `M${N(e.time, t).toFixed(2)},${yr(e.value, n).toFixed(2)}h0`).join("");
}
function $r(e, t, n, r, i) {
	...
	for (let s of e) {
		...
		let c = {
			...
			top: 28,
			height: i
		}, l = fr(Dr(s.points, n, s.lineMode, r), n, 40, 640), { points: u, pathLength: d } = s.lineMode === "line" ? Fr(l, n, c) : Pr(l, n, c);
		if (a.push({
			id: s.id,
			color: s.color,
			points: u,
...
function ei(e, t, n, r, i) {
	return e.filter((e) => (e.valueType === "number" || e.valueType === "boolean") && e.lineMode === "column").flatMap((e) => {
		...
		return Sr(e, n, i.extendColumnToEnd).flatMap((t, r) => {
			...
			let a = N(t.start, n), c = N(t.end, n), l = yr(i, o);
			return [{
				id: `${e.id}:${r}`,
				x: a,
				y: Math.min(l, s),
...
function ri(e, t) {
	let n = t - 10, r = ni(t), i = e.ticks.length <= r ? e.ticks : Un(e.min, e.max, r), a = Math.max(Math.abs(e.max - e.min), 1) * 1e-9, o = i.filter((t) => t >= e.min - a && t <= e.max + a), s = o.length > 0 ? o : [e.min, e.max], c = e.ticks === i ? e.precision : Math.max(e.precision, Kn(s));
	return s.map((t) => ({
...
function ii(e, t, n) {
	...
	return {
		allSeries: e.map((e, t) => {
			let a = In(e.color, r, n * En.length + t);
			return r.add(Ln(a)), i.set(e.id, a), a === e.color ? e : {
				...e,
				color: a
			};
		}),
...
function oi(e, t = 12, n = 180) {
	...
	for (let t = 0; t < l.length; t++) {
		let s = l[t], d = e.numericScales.filter((e) => e.graphKey === s), f = d.find((e) => e.axis === "left") ?? d[0], p = d.find((e) => e.axis === "right"), m = new Set(d.flatMap((e) => [...e.ids])), h = d[0]?.sourceGraphKey ?? s, g = e.allSeries.filter((e) => (e.valueType === "number" || e.valueType === "boolean") && Kr(e) === h), _ = g.filter((e) => Jr(e, g) === s), v = e.visibleSeries.filter((e) => m.has(e.id)), y = ai(o, u, t, !0), b = ai(a, u, t, !0), ee = [...v, ...y], te = ii([..._, ...b], ee, t), x = te.visibleSeries.filter((e) => e.valueType !== "number" && e.valueType !== "boolean"), ne = x.length, re = 28 + n + 16 + 6, S = ne > 0 ? 22 + ne * 14 : 0, ie = 28 + n + S + 18, ae = ie + (ne > 0 ? 0 : 16), C = ri(f, n), oe = p ? ri(p, n) : [], se = d.map((e) => ({
			...e,
			top: 28,
			height: n
		})), ce = se.find((e) => e.axis === "left") ?? se[0], le = $r(te.visibleSeries, se, i, { extendStairToEnd: e.extendStairToEnd }, n);
		r.push({
			series: te.visibleSeries,
			allSeries: te.allSeries,
			scale: ce,
			scales: se,
			graphHeight: n,
			svgHeight: ie,
			canvasHeight: ae,
			lines: le.lines,
			pointMarkers: le.pointMarkers,
			columns: ei(te.visibleSeries, se, i, n, { extendColumnToEnd: e.extendStairToEnd }),
			segments: ti(x, re, i),
			yLabels: C,
			rightYLabels: oe,
			xLabels: c,
			heatingAreas: e.heatingAreas.length > 0 ? _r(e.visibleSeries, se, i) : []
		});
	}
	return r;
}
...
function Ei(e, t, n) {
	let r = e?.states[t];
	return r ? n ? Zt(r, n)?.valueType ?? "string" : Xt(r)?.valueType ?? "string" : "number";
}
function Di(e, t, n) {
	let r = e?.states[t];
	return !r || vt(n ? n.reduce((e, t) => typeof e == "object" && e ? e[t] : void 0, r.attributes) : r.state);
}
function Oi(e) {
...
function Li(e, t, n) {
	...
	return [e, ...gi.map((a) => {
		let o = [a], s = wi(e.entity, o), c = Ei(n, e.entity, o), l = Dn[a] ?? jn(t()), u = a === "current_temperature" || a === "temperature" ? r : void 0, d = a === "hvac_action" ? void 0 : i ?? "temperature";
		return {
			id: s,
			entity: e.entity,
			attribute: o,
...
function Ri(e) {
	return e.find((e) => e.scaleGroupKey === "group:temperature" && e.unit && M(e.unit))?.unit ?? e.find((e) => e.unit && M(e.unit))?.unit;
}
function zi(e) {
	let t = Ri(e), n = e.some((e) => e.scaleGroupKey === "group:temperature");
	return e.map((e) => {
		let r = ui(e.unit), i = Ni(e), a = t && (r || zn(e.unit, t) || e.unit === void 0 && i) ? t : e.unit, o = e.scaleGroupKey;
		if (a && o.startsWith("unit:")) {
			let e = o.slice(5);
			(r && e === "temperature" || zn(e, a)) && (o = `unit:${a}`);
		}
		return n && e.valueType === "number" && a && M(a) && o.startsWith("unit:") && !_i(e) && (o = "group:temperature"), a !== e.unit || o !== e.scaleGroupKey ? {
			...e,
			unit: a,
			scaleGroupKey: o
		} : e;
...
async function $i() {
	try {
		await gt(["ha-target-picker"]), Xi = customElements.get("ha-target-picker") !== void 0, Xi || ea();
	} catch (e) {
		ea(e);
	}
	return Xi;
...
async function ta(e, t) {
	try {
		...
		throw e instanceof Ue ? console.warn(`[ha-better-history] Failed to load ${t}. Missing: ${e.result.missing.join(", ") || "unknown"}.`, e.cause ?? e) : console.warn(`[ha-better-history] Failed to load ${t}.`, e), e;
	}
}
function na() {
...
function Ea(e) {
    ...
    >
      ...
      >
        ${e.targetPickerReady ? w`
              ${Da(e)}
              ${n.length > 0 ? w`<div class="source-chip-row">
                    ${n.map((t) => Na(t, e))}
                  </div>` : E}
            ` : w`
      ...
      ${e.hideEmptyPickerState && !e.targetPickerReady ? Aa(e) : E}
      ${e.loading ? w`
...
function Da(e) {
	...
	return e.disableTargetPickerWhileLoading ? w`
    <ha-target-picker
      class="target-picker"
      .hass=${e.hass}
...
function Na(e, t) {
    ...
    >
      <span class="source-chip-icon">
        ${i && a ? w`<ha-icon .icon=${Ma(a)}></ha-icon>` : w`<ha-icon .icon=${Ia(e.valueType)}></ha-icon>`}
      </span>
...
function La(e) {
    ...
    <div class="entity-browser">
      ...
      <div class="entity-browser-list">
        ${t ? za(t, n, da(r) ? r : {}, e) : w`<div class="entity-browser-empty">${P(e.hass, "no_entity_selected")}</div>`}
      </div>
    </div>
  `;
}
...
function za(e, t, n, r) {
	let i = Object.entries(n).sort(([e], [t]) => e.localeCompare(t)), a = i.some(([n, r]) => da(r) ? !0 : Yt(r) !== void 0 && !!Zt(e, [...t, n]));
	return w`
...
function Ja(e, t) {
    ...
    ` : t.explicitTargetEntityIds?.includes(e.entity_id) ? w`
    ...
    ` : t.targetEntityIds?.includes(e.entity_id) ? w`
...
function Za(e, t) {
	...
	return r.length === 0 ? w`<div class="entity-browser-search-empty">${P(t.hass, "no_matching_attributes")}</div>` : w`
    <div class="entity-browser-search-results">
      ...
      ${n.length > r.length ? w`<div class="entity-browser-search-count">${P(t.hass, "attribute_results_limited")}</div>` : E}
    </div>
  `;
}
function Qa(e, t, n) {
...
function uo(e, t) {
	return lo(e, t).map((t) => e.states[t]).filter((e) => e !== void 0).map(Xt).filter((e) => e !== void 0);
}
function fo(e) {
...
function cs(e) {
	let t = ss(e);
	return t ? e.map((e) => {
		let n = zn(e.unit, t) || e.unit === void 0 && os(e) ? t : e.unit;
		return n === e.unit ? e : {
			...e,
			unit: n
		};
...
var L = class extends D {
	...
	_resolvedTemperatureUnit() {
		return this._resolved?.series.find((e) => e.scaleGroupKey === "group:temperature" && e.unit && M(e.unit))?.unit;
	}
	_resolvedSourceValueTypePromotionPending() {
		...
		return this._lastFetchSources.some((t) => {
			...
			if (!n) return !1;
			let r = t.kind === "entity_attribute" ? Zt(n, t.path ?? []) : Xt(n);
	...
	willUpdate(e) {
		...
		if (u.some((t) => e.has(t))) {
			...
			let o = this._fetchSources(), s = St(o), c = t ? `${s}|rolling|${this._relativeRangeMs()}` : `${s}|${i.startDate.getTime()}|${i.endDate.getTime()}`;
			if (c !== this._lastFetchKey) {
				let e = s === St(this._lastFetchSources) && this._lastFetchKey !== "";
	...
	_pickScaleGroup(e, t, n) {
		...
		if (e.unit) {
			let n = t.find((t) => t.valueType === "number" && (t.unit === e.unit || zn(t.unit, e.unit)));
			if (n) return n.scaleGroupKey;
			let r = this._resolved?.series.find((t) => t.valueType === "number" && (t.unit === e.unit || zn(t.unit, e.unit)));
			if (r) return r.scaleGroupKey;
			let i = this._resolved?.series.find((e) => e.scaleGroupKey === "group:temperature");
			if (i && M(e.unit)) return i.scaleGroupKey;
			let a = t.find((e) => e.scaleGroupKey === "group:temperature");
			if (a && M(e.unit)) return a.scaleGroupKey;
		}
		if (i) {
			let e = t.find((e) => e.valueType === "number" && e.unit !== void 0 && M(e.unit));
	...
	_renderSeriesFromSource(e, t, n, r, i = e.unit) {
		...
		return {
			...
			entity: e.entityId,
			label: e.label,
			color: o?.color ?? (a ? Dn[a] : void 0) ?? jn(r),
			unit: i,
			scaleGroupKey: n,
			scaleMode: "auto",
	...
	_unitForScaleGroup(e, t, n) {
		if (!e.unit || !M(e.unit)) return e.unit;
		let r = n.find((n) => n.scaleGroupKey === t && zn(n.unit, e.unit));
		return r?.unit ? r.unit : this._activeResolvedSeries().find((n) => n.scaleGroupKey === t && zn(n.unit, e.unit))?.unit ?? e.unit;
	}
	_defaultLineMode() {
	...
	_chartData() {
		...
		}, p = this._data.debugPerformance, m = p ? A() : 0, h = Xr(u, d, f, this._resolved?.disableClimateOverlay ?? !1, l, s, c), g = p ? A() - m : 0;
		return p && j(p, "chart.build_data", {
	...
	_renderGraphGroup(e, t, n) {
      ...
      <div class="graph-section">
        <div class="graph-row" style=${`--axis-label-gap:${Qo}px;--axis-left-gutter:${n.left};--axis-right-gutter:${n.right};`}>
          ...
          >
            ${a ? this._renderAxisColorDots(e, s, "left") : E}
            ${a ? e.yLabels.map((e) => w`<span class="y-axis-label y-axis-label--left" style="top:${e.y.toFixed(1)}px;">${e.value}</span>`) : E}
          </div>
          <div
            class="graph-canvas"
            data-series-ids=${o}
          ...
          >
			...
			return T`<polyline class="line" style=${`--better-history-line-width:${e.lineWidth};`} clip-path="url(#${r})" data-line-id=${e.id} data-line-dom-key=${n} data-animate-clip=${a ? "true" : E} data-target-x=${i} points=${e.points} stroke=${e.color}></polyline>`;
		})}
			...
			return T`
              ...
              ${e.series.filter((e) => e.valueType !== "number" && e.valueType !== "boolean").map((e, t) => T`<rect class="segment-border" x=${40} y=${d + t * 14} width=${640} height="9" fill="none" stroke=${e.color}></rect>`)}
              ${a ? T`<line class="axis" x1=${40} y1=${18} x2=${40} y2=${l}></line>` : E}
              ${a && e.rightYLabels.length > 0 ? T`<line class="axis" x1=${680} y1=${18} x2=${680} y2=${l}></line>` : E}
              ${a ? T`<line class="axis" x1=${40} y1=${l} x2=${680} y2=${l}></line>` : E}
              ${a && e.scale ? e.yLabels.map((e) => T`
                      <line class="axis tick" x1=${40} y1=${e.y.toFixed(1)} x2=${44} y2=${e.y.toFixed(1)}></line>
                    `) : E}
              ${a ? e.rightYLabels.map((e) => T`
                      <line class="axis tick" x1=${676} y1=${e.y.toFixed(1)} x2=${680} y2=${e.y.toFixed(1)}></line>
                    `) : E}
            </svg>
            ${a ? e.xLabels.map((e) => {
			let t = ((e.x - 40) / 640 * 100).toFixed(2);
			return w`<span class="x-axis-label ${e.bold ? "x-axis-label--bold" : ""}" style="left:${t}%;top:${u}px;">${e.label}</span>`;
		}) : E}
          </div>
          <div
          ...
          >
            ${a ? this._renderAxisColorDots(e, c, "right") : E}
            ${a ? e.rightYLabels.map((e) => w`<span class="y-axis-label y-axis-label--right" style="top:${e.y.toFixed(1)}px;">${e.value}</span>`) : E}
          </div>
        </div>
        ${r && e.allSeries.length > 0 ? w`
	...
	_renderAxisColorDots(e, t, n) {
      ...
      >
        ${a && n === "left" ? w`<span class="axis-drop-preview"><span class="axis-color-dot" style="background:${a};"></span></span>` : E}
        ${t.map((t) => {
        ...
        ${a && n === "right" ? w`<span class="axis-drop-preview"><span class="axis-color-dot" style="background:${a};"></span></span>` : E}
      </span>
    `;
	}
	...
	_renderChartBody() {
		if (this._data.error) {
			...
			return w`<div class="error">${P(this.hass, e ? "error_timeout" : "error")}</div>`;
		}
		if (!this._resolved || this._resolved.series.length === 0 && this._selectedSourcesForDisplay().length === 0) return this._queueGraphVisible(!1), E;
      ...
      <div class="chart-surface">
        ${a ? w`
              ...
              </div>` : this._data.loading ? E : w`<div class="empty">${P(this.hass, "empty")}</div>`}
      </div>
    `;
	}
	_renderEntityPickerUI() {
		return !this._resolved?.showEntityPicker || !this._entityComponentsReady || !this._targetPickerLoadComplete ? E : Ea({
			hass: this.hass,
	...
	_applyImportedData(e) {
		...
		let o = St(this._importedSources);
	...
	_renderDatePicker() {
		return !this._resolved?.showDatePicker || !this._datePickerReady ? E : aa({
			hass: this.hass,
	...
	_onTargetSelectionChanged(e, t = !0) {
		...
		for (let e of l.filter((e) => !i.has(e))) {
			if (t) continue;
			let n = this.hass?.states[e] ? Xt(this.hass.states[e]) : void 0;
...
I([O({ attribute: !1 })], L.prototype, "hass", void 0), I([O({ attribute: !1 })], L.prototype, "config", void 0), I([O({ attribute: !1 })], L.prototype, "entities", void 0), I([O({ attribute: !1 })], L.prototype, "attributeUnits", void 0), I([O({ type: Number })], L.prototype, "hours", void 0), I([O({ attribute: !1 })], L.prototype, "startDate", void 0), I([O({ attribute: !1 })], L.prototype, "endDate", void 0), I([O({
	type: Boolean,
	attribute: "show-date-picker"
})], L.prototype, "showDatePicker", void 0), I([O({
	type: Boolean,
	attribute: "show-entity-picker"
})], L.prototype, "showEntityPicker", void 0), I([O({
	type: Boolean,
	attribute: "show-import-button"
})], L.prototype, "showImportButton", void 0), I([O({
	type: Boolean,
	attribute: "show-export-button"
})], L.prototype, "showExportButton", void 0), I([O({
	type: Boolean,
	attribute: "show-time-range-selector"
})], L.prototype, "showTimeRangeSelector", void 0), I([O({
	type: Boolean,
	attribute: "show-line-mode-buttons"
})], L.prototype, "showLineModeButtons", void 0), I([O({
	type: Boolean,
	attribute: "show-legend"
})], L.prototype, "showLegend", void 0), I([O({
	type: Boolean,
	attribute: "show-tooltip"
})], L.prototype, "showTooltip", void 0), I([O({
	type: Boolean,
	attribute: "show-grid"
})], L.prototype, "showGrid", void 0), I([O({
	type: Boolean,
	attribute: "show-scale"
})], L.prototype, "showScale", void 0), I([O({
	type: Boolean,
	attribute: "auto-scale-split"
})], L.prototype, "autoScaleSplit", void 0), I([O({
	type: Boolean,
	attribute: "show-controls"
})], L.prototype, "showControls", void 0), I([O()], L.prototype, "width", void 0), I([O()], L.prototype, "height", void 0), I([O({ attribute: "line-mode" })], L.prototype, "lineMode", void 0), I([O({ attribute: "line-width" })], L.prototype, "lineWidth", void 0), I([O({ attribute: "background-color" })], L.prototype, "backgroundColor", void 0), I([O({ attribute: "graph-title" })], L.prototype, "graphTitle", void 0), I([O({ attribute: "title-font-family" })], L.prototype, "titleFontFamily", void 0), I([O({ attribute: "title-font-size" })], L.prototype, "titleFontSize", void 0), I([O({ attribute: "title-color" })], L.prototype, "titleColor", void 0), I([O()], L.prototype, "language", void 0), I([O({
	type: Boolean,
	attribute: "debug-performance"
})], L.prototype, "debugPerformance", void 0), I([O({
	type: Boolean,
	attribute: "tools-open"
})], L.prototype, "toolsOpen", void 0), I([k()], L.prototype, "_resolved", void 0), I([k()], L.prototype, "_hiddenSeriesIds", void 0), I([k()], L.prototype, "_rangeStart", void 0), I([k()], L.prototype, "_rangeEnd", void 0), I([k()], L.prototype, "_viewStart", void 0), I([k()], L.prototype, "_viewEnd", void 0), I([k()], L.prototype, "_liveNow", void 0), I([k()], L.prototype, "_datePickerReady", void 0), I([k()], L.prototype, "_entityComponentsReady", void 0), I([k()], L.prototype, "_targetPickerReady", void 0), I([k()], L.prototype, "_targetPickerLoadComplete", void 0), I([k()], L.prototype, "_runtimeLineMode", void 0), I([k()], L.prototype, "_attributeMenuOpen", void 0), I([k()], L.prototype, "_attributeSearch", void 0), I([k()], L.prototype, "_selectedEntityId", void 0), I([k()], L.prototype, "_path", void 0), I([k()], L.prototype, "_selectedSources", void 0), I([k()], L.prototype, "_selectedTargets", void 0), I([k()], L.prototype, "_removedConfigSourceIds", void 0), I([k()], L.prototype, "_scalePreferences", void 0), I([k()], L.prototype, "_customEntityIds", void 0), I([k()], L.prototype, "_entityPickerOpen", void 0), I([k()], L.prototype, "_datePickerOpen", void 0), I([k()], L.prototype, "_draggingSourceId", void 0), I([k()], L.prototype, "_draggingAxisSeriesId", void 0), I([k()], L.prototype, "_axisDropTarget", void 0), I([k()], L.prototype, "_sourceSettingsSourceId", void 0), I([k()], L.prototype, "_entityActionsEntityId", void 0), I([k()], L.prototype, "_pendingAddedSources", void 0), I([k()], L.prototype, "_importedDataActive", void 0), I([k()], L.prototype, "_containerWidth", void 0), I([k()], L.prototype, "_chartSurfaceHeight", void 0), I([k()], L.prototype, "_chartSurfaceConstrained", void 0);
...
var R = class extends D {
	...
	render() {
		return !this._componentsReady || !this._targetPickerLoadComplete ? w`` : w`
      ${Ea({
			hass: this.hass,
			menuOpen: this._attributeMenuOpen,
			entityPickerOpen: this._entityPickerOpen,
      ...
      ${this._targetPickerReady && (!oo(this._selectedTargets) || this._selectedSources.length > 0) ? w`<button class="target-picker-done" @click=${() => this._confirm()}>${P(this.hass, "done")}</button>` : w``}
    `;
	}
...
I([O({ attribute: !1 })], R.prototype, "hass", void 0), I([O({ attribute: !1 })], R.prototype, "initialSources", void 0), I([O({
	type: Boolean,
	attribute: "browser-history"
})], R.prototype, "browserHistory", void 0), I([k()], R.prototype, "_selectedSources", void 0), I([k()], R.prototype, "_selectedTargets", void 0), I([k()], R.prototype, "_attributeMenuOpen", void 0), I([k()], R.prototype, "_entityPickerOpen", void 0), I([k()], R.prototype, "_selectedEntityId", void 0), I([k()], R.prototype, "_entitySearch", void 0), I([k()], R.prototype, "_path", void 0), I([k()], R.prototype, "_attributeSearch", void 0), I([k()], R.prototype, "_componentsReady", void 0), I([k()], R.prototype, "_targetPickerReady", void 0), I([k()], R.prototype, "_targetPickerLoadComplete", void 0), I([k()], R.prototype, "_customEntityIds", void 0), I([k()], R.prototype, "_sourceSettingsSourceId", void 0), customElements.get("abh-series-picker") || customElements.define("abh-series-picker", R);
	...
	en: {
		...
		main: {
			...
			fan: {
				...
				None: "None",
				Turbo: "Turbo",
				plugin_enabled: "Auto-fan enabled",
				plugin_disabled: "Auto-fan disabled",
				unavailable: "Fan"
			},
			swing: {
				off: "Off",
			...
			messages: {
				hvac_off_manual: "Turned off manually",
				hvac_off_auto_start_stop: "Turned off by auto-start/stop",
				hvac_fan_only_auto_start_stop: "Set to fan only by auto-start/stop",
				hvac_dry_auto_start_stop: "Set to dry by auto-start/stop",
				hvac_off_window_detection: "Turned off by window detection",
				hvac_off_sleep_mode: "Turned off by sleep mode",
				hvac_off_safety_detection: "Turned off by safety mode",
				hvac_off_central_mode: "Turned off by central mode",
		...
		dialog: {
			...
			fan: {
				title: "Ventilation",
				description_auto: "Auto mode automatically adapts ventilation to heating needs.",
				plugin_enabled: "Auto-fan is enabled",
				plugin_disabled: "Auto-fan is disabled",
				enable_plugin: "Enable auto-fan",
				disable_plugin: "Disable auto-fan",
				selected_mode: "Selected fan mode",
				plugin_read_only: "Configure the auto-fan switch entity to control this plugin from Equinox.",
				action_failed: "The auto-fan action failed."
			},
			auto_start_stop: {
				title: "Auto-start/stop",
				read_only: "Configure the auto-start/stop switch and stop-mode select entities to control this feature from Equinox.",
				action_failed: "The auto-start/stop action failed.",
				mode: {
					disabled: "Disabled",
					off: "Turn off",
					fan_only: "Fan only",
		...
		editor: {
			...
			humidity_entity: "Humidity entity",
			temperature_entity: "Temperature entity",
			auto_start_stop_enable_entity: "Auto-start/stop switch",
			auto_start_stop_stop_mode_entity: "Auto-start/stop stop mode",
			auto_fan_enable_entity: "Auto-fan plugin switch",
			theme: "Theme",
			display_mode: "Format",
			primary_display: "Display priority",
	...
	fr: {
		...
		main: {
			...
			fan: {
				...
				None: "Aucune",
				Turbo: "Turbo",
				plugin_enabled: "Auto-fan activé",
				plugin_disabled: "Auto-fan désactivé",
			...
			messages: {
				...
				hvac_fan_only_auto_start_stop: "Ventilation seule par auto-start/stop",
				hvac_dry_auto_start_stop: "Déshumidification par auto-start/stop",
		...
		dialog: {
			...
			fan: {
				...
				plugin_enabled: "L'auto-fan est activé",
				plugin_disabled: "L'auto-fan est désactivé",
				enable_plugin: "Activer l'auto-fan",
				disable_plugin: "Désactiver l'auto-fan",
				selected_mode: "Mode de ventilation sélectionné",
				plugin_read_only: "Configurez l'entité switch de l'auto-fan pour piloter ce plugin depuis Equinox.",
				action_failed: "L'action auto-fan a échoué."
			},
			auto_start_stop: {
				title: "Auto-start/stop",
				read_only: "Configurez le switch auto-start/stop et le select du mode d'arrêt pour piloter cette fonction depuis Equinox.",
				action_failed: "L'action auto-start/stop a échoué.",
				mode: {
					disabled: "Désactivé",
					off: "Extinction",
		...
		editor: {
			...
			auto_start_stop_enable_entity: "Switch auto-start/stop",
			auto_start_stop_stop_mode_entity: "Mode d'arrêt auto-start/stop",
			auto_fan_enable_entity: "Switch du plugin auto-fan",
			theme: "Thème",
			display_mode: "Format",
...
function Ks({ config: e, family: t, mode: n, defaultTone: r }) {
	let i = Us(e, t, n)?.tone;
...
function Zs() {
	return Js.every((e) => customElements.get(e)) ? Promise.resolve() : (Ys ??= Qs(), Ys);
}
async function Qs() {
	try {
		await gt(Js);
	} catch (e) {
		throw Ys = void 0, Xs || (Xs = !0, e instanceof Ue ? console.warn(`[equinox-card] Failed to load Home Assistant UI components. Missing: ${e.result.missing.join(", ") || "unknown"}.`, e.cause ?? e) : console.warn("[equinox-card] Failed to load Home Assistant UI components.", e)), e;
	}
}
//#endregion
//#region src/types/config.ts
var $s = ["flat", "liquid_glow"], ec = [
	"classic",
	"compact",
	"thin"
], tc = ["setpoint", "sensors"], nc = ["slider", "buttons"], rc = [
	"auto",
	"custom",
	"disabled"
], ic = ["horizontal", "vertical"], ac = {
	theme: vs,
	display_mode: ys,
	primary_display: bs,
...
function cc(e) {
	...
	let n = qs(t.mode_customizations);
...
var lc = class extends D {
  ...
  `;
	...
	connectedCallback() {
		super.connectedCallback(), Zs().catch(() => void 0);
	}
	setConfig(e) {
		this._config = cc(e);
	}
	...
	_renderModeTab(e, t) {
      ...
      <div class="options-panel">
        ...
        ${n.length === 0 ? w`<div class="options-empty">${z(e, this._config.entity ? r : "editor.visibility.no_entity")}</div>` : w`
			...
			return w`<div class="mode-card">
                    ...
                    <div class="mode-fields">
                      ...
                      <label>${z(e, "editor.mode_customization.tone")}<select .value=${r.tone ?? ""} @change=${(e) => this._commitModeCustomization(t, n, { tone: e.currentTarget.value })}>
                        ...
                        ${Bs[t].map((e) => w`<option value=${e}>${e}</option>`)}
                      </select></label>
                    </div>
                  </div>`;
		})}
	...
	_modeField(e, t, n, r, i) {
		return w`<label>${z(e, `editor.mode_customization.${t}`)}<input
      type="text"
      .value=${n}
	...
	_colorChanged(e, t) {
		let n = { ...this._config }, r = sc(t.detail.value);
		r === void 0 || r === "" ? delete n[e] : n[e] = r, this._config = cc(n), this._emitConfigChanged();
	}
	_climateEntity() {
		let e = this._config.entity;
		return e ? this.hass?.states[e] : void 0;
	}
	_vtFeatureVisibility() {
		let e = this._climateEntity()?.attributes, t = e?.auto_fan;
		return {
			autoStartStop: e?.is_auto_start_stop_configured === !0,
			autoFanPlugin: typeof t == "object" && !!t && !Array.isArray(t)
		};
	}
	_attributeModes(e) {
	...
	_flushModeCustomizations() {
		...
		this._pendingModeCustomizations.clear(), this._config = cc(e), this._emitConfigChanged();
	}
	_computeLabel(e) {
...
customElements.get("equinox-card-editor") || customElements.define(_s, lc);
//#endregion
...
async function pc(e, t) {
	return H(e) ? U() : fc(t.targetTempLow) && fc(t.targetTempHigh) ? G(e, "climate", "set_temperature", {
		entity_id: e.entityId,
		target_temp_low: t.targetTempLow,
		target_temp_high: t.targetTempHigh
	}) : fc(t.temperature) ? G(e, "climate", "set_temperature", {
		entity_id: e.entityId,
...
async function yc(e, t, n) {
	return H(e) ? U() : !e.viewModel?.vt?.isVt || !e.viewModel.vt.timedPresetManager ? W() : !Number.isInteger(n) || n < 1 || n > 1440 || t.trim() === "" ? dc() : G(e, "versatile_thermostat", "set_timed_preset", {
		entity_id: e.entityId,
		preset: t,
		duration_minutes: n
	});
...
async function xc(e, t) {
	if (H(e)) return U();
	if (e.viewModel?.vt?.fan.kind !== "legacy") return W();
	let n = uc[t];
...
async function Sc(e, t) {
	if (H(e)) return U();
	let n = e.config?.auto_fan_enable_entity;
	return e.viewModel?.vt?.fan.kind !== "plugin" || !e.viewModel.vt.fan.pluginSwitchAvailable || !n ? W() : n.startsWith("switch.") ? G(e, "switch", t ? "turn_on" : "turn_off", { entity_id: n }) : dc();
}
async function Cc(e, t) {
	if (H(e)) return U();
	let n = e.viewModel?.vt?.autoStartStop, r = e.config?.auto_start_stop_enable_entity, i = e.config?.auto_start_stop_stop_mode_entity;
	if (!n?.isConfigured || !n.enableEntityAvailable || !n.stopModeEntityAvailable || !r || !i) return W();
	if (!r.startsWith("switch.") || !i.startsWith("select.")) return dc();
	if (t === "disabled") return G(e, "switch", "turn_off", { entity_id: r });
	if (!n.stopModeOptions.includes(t)) return dc();
	if (!n.isEnabled) {
		let t = await G(e, "switch", "turn_on", { entity_id: r });
		if (!t.ok) return t;
	}
	return G(e, "select", "select_option", {
		entity_id: i,
		option: t
	});
}
...
function K(e) {
	return e ? e === "idle" ? "muted" : e === "off" ? "off" : Dc[Ec[e] ?? e] ?? "" : "";
}
function Oc(e, t) {
	switch (e) {
...
function Ic(e) {
	...
	let t = `${e.source}:${e.algorithm}`, n = Fc.get(t);
	if (n) return n;
	let r = e.source === "custom" ? zc(e.algorithm) : Promise.resolve(Rc(e.algorithm));
	return Fc.set(t, r), r;
}
function Lc(e) {
	if (!Bc(e) || e.schema_version !== 1 || e.kind !== "regulation-dashboard" || !Array.isArray(e.sections) || e.sections.length === 0) return !1;
	let t = /* @__PURE__ */ new Set();
	return e.sections.every((e) => !Bc(e) || typeof e.id != "string" || !Vc(e.id) || !Array.isArray(e.items) || t.has(e.id) ? !1 : (t.add(e.id), e.items.every(Hc)));
}
function Rc(e) {
	let t = Nc(e);
	return t ? Lc(t) ? {
...
function Hc(e) {
	return !Bc(e) || typeof e.type != "string" ? !1 : e.type === "layout_grid" ? Array.isArray(e.items) && e.items.every(Hc) : [
		"hero_status",
		"value",
		"metric_grid",
		"status",
...
var Uc = "specific_states/regulation_diagnostics";
function Wc(e) {
...
function Jc(e, t) {
	...
	return Wc(Kc(n, Uc)) ?? Wc(t.diagnostic_entity);
}
function Yc(e, t) {
	let n = Jc(e, t);
	return {
...
function Xc(e, t) {
	return Yc(e.hass, e.config)[t];
}
function Zc(e, t, n) {
	let r = Xc(e, t);
	if (!r) return;
	if (t === "config") return Kc(r, n);
	let i = Gc(n);
	if (i.length === 0) return r;
	let a = i[0];
	if (a === "state" || a === "attributes" || a === "entity_id") return Kc(r, i);
	let o = Kc(r.attributes, i);
	return o === void 0 ? Kc(r, i) : o;
}
//#endregion
...
`, ol = class extends D {
  ...
  `;
	...
	render() {
		...
		return w`
      ${r ? E : w`<div class=${o} @click=${this._dispatchClose}></div>`}
      <div
        class=${a}
        style=${i}
        popover=${r ? "auto" : E}
...
customElements.get("eq-dialog") || customElements.define("eq-dialog", ol);
//#endregion
//#region src/components/eq-auto-start-stop-dialog.ts
var sl = "disabled", cl = class extends D {
	constructor(...e) {
		super(...e), this.open = !1, this.floating = !1, this.closeOnLeave = !1, this._pending = !1;
	}
	static {
		this.properties = {
			open: { type: Boolean },
  ...
  `;
	...
	_isWritable() {
		let e = this._state();
		return e?.enableEntityAvailable === !0 && e.stopModeEntityAvailable === !0;
	}
	_isDisabled() {
		return this._pending || !this._isWritable() || this.viewModel?.climate.availability !== "available" || this.viewModel?.vt?.lock.isUserLocked === !0;
	}
	_currentMode() {
		let e = this._state();
		return e?.isEnabled ? e.stopMode ?? "off" : sl;
	}
	_modeLabel(e) {
		return z(this.language, `dialog.auto_start_stop.mode.${e}`);
	}
	_modeIcon(e) {
		return e === sl ? "mdi:power-off" : e === "fan_only" ? "mdi:fan" : e === "dry" ? "mdi:water-percent" : "mdi:power";
	}
	async _selectMode(e) {
		if (!this.hass || !this.config || this._isDisabled()) return;
		this._pending = !0, this._error = void 0;
		let t = await Cc({
			hass: this.hass,
		...
		this._pending = !1, t.ok ? this._dispatchClose() : this._error = t.error;
	}
	render() {
		let e = this._state(), t = this._currentMode(), n = [sl, ...e?.stopModeOptions ?? []], r = this._isDisabled();
		return w`
      <eq-dialog
        .open=${this.open}
        .title=${z(this.language, "dialog.auto_start_stop.title")}
        .language=${this.language}
      ...
      >
        <div class="mode-list" role="list">
          ${n.map((e) => w`
            ...
            >
              <span class="mode-icon" ?disabled=${e === sl}>
                <ha-icon .icon=${this._modeIcon(e)}></ha-icon>
              </span>
              <span>${this._modeLabel(e)}</span>
              ${e === t ? w`<ha-icon class="check" icon="mdi:check"></ha-icon>` : E}
            </button>
          `)}
        </div>
        ${this._isWritable() ? E : w`<p class="note">${z(this.language, "dialog.auto_start_stop.read_only")}</p>`}
        ${this._error ? w`<p class="error">${z(this.language, "dialog.auto_start_stop.action_failed")}</p>` : E}
      </eq-dialog>
    `;
	}
};
customElements.get("eq-auto-start-stop-dialog") || customElements.define("eq-auto-start-stop-dialog", cl);
//#endregion
...
var ll = class extends D {
  ...
  `;
	...
	_getOptions() {
		return this.viewModel?.vt?.fan.kind === "legacy" ? js.filter((e) => !Ws(this.config, "fan", e)) : (this.viewModel?.climate.fanModes ?? []).filter((e) => !Ws(this.config, "fan", e));
	}
	_getActiveMode() {
		return this.viewModel?.vt?.fan.kind === "legacy" ? this.viewModel.vt.fan.currentAutoFanMode : this.viewModel?.climate.fanMode;
	}
	_fanIcon(e) {
		return B({
			config: this.config,
	...
	async _selectMode(e) {
		...
		this._error = void 0;
		let n = this.viewModel?.vt?.fan.kind === "legacy" ? await xc(t, e) : await gc(t, e);
		n.ok ? this._dispatchClose() : this._error = n.error;
	}
	async _togglePlugin() {
		let e = this.viewModel?.vt?.fan;
		if (!this.hass || !this.config || e?.kind !== "plugin" || !e.pluginSwitchAvailable) return;
		this._error = void 0;
		let t = await Sc({
			hass: this.hass,
			entityId: this.config.entity,
		...
		t.ok ? this._dispatchClose() : this._error = t.error;
	}
	_renderPlugin() {
		let e = this.viewModel?.vt?.fan, t = e?.isEnabled === !0, n = e?.pluginSwitchAvailable === !0, r = !n || this.viewModel?.climate.availability !== "available" || this.viewModel?.vt?.lock.isUserLocked === !0, i = z(this.language, t ? "dialog.fan.plugin_enabled" : "dialog.fan.plugin_disabled"), a = z(this.language, t ? "dialog.fan.disable_plugin" : "dialog.fan.enable_plugin");
		return w`
      <div class="plugin-summary">
        ...
        >
          <span class="option-icon" tone=${t ? "fan-auto" : "fan-off"}>
            <ha-icon .icon=${t ? "mdi:fan-auto" : "mdi:fan-off"}></ha-icon>
          </span>
          <span>${n ? a : i}</span>
          ${t ? w`<ha-icon class="option-check" icon="mdi:check"></ha-icon>` : E}
        </button>
        ${e?.selectedFanMode ? w`<div class="plugin-mode">${z(this.language, "dialog.fan.selected_mode")}: ${e.selectedFanMode}</div>` : E}
        ${n ? E : w`<p class="plugin-note">${z(this.language, "dialog.fan.plugin_read_only")}</p>`}
        ${this._error ? w`<p class="error">${z(this.language, "dialog.fan.action_failed")}</p>` : E}
      </div>
    `;
	}
	render() {
		let e = this._getOptions(), t = this._getActiveMode(), n = z(this.language, "dialog.fan.title"), r = this.viewModel?.vt?.fan.kind === "plugin";
		return w`
      <eq-dialog
        .open=${this.open}
        .title=${n}
...
customElements.get("eq-fan-dialog") || customElements.define("eq-fan-dialog", ll);
//#endregion
...
var ul = class extends D {
  ...
  `;
	...
	async _selectMode(e) {
		!this.hass || !this.config || (await mc({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
      ...
      >
        <div class="option-grid option-desktop">
          ${e.map((e) => w`
              ...
              >
                <span class="option-icon" tone=${Ks({
			config: this.config,
			family: "hvac",
			mode: e,
			defaultTone: ws[e]
...
customElements.get("eq-hvac-dialog") || customElements.define("eq-hvac-dialog", ul);
//#endregion
...
var dl = class extends D {
  ...
  `;
	...
	async _selectVerticalMode(e) {
		!this.hass || !this.config || (await _c({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
		}, e), this._dispatchClose());
	...
	_renderDesktopGroup(e, t, n, r) {
      ...
      <div class="swing-grid">
        ${e.map((e) => w`
            ...
            >
              <span class="swing-option-icon" tone=${Ks({
			config: this.config,
      ...
      >
        <div class="swing-content">
          <div class="swing-desktop">
            ${e.length > 0 ? w`
                  <div class="group">
                    ${n ? w`<span class="group-title">${z(this.language, "dialog.swing.vertical")}</span>` : E}
                    ${this._renderDesktopGroup(e, this.viewModel?.climate.swingMode, !1, (e) => this._selectVerticalMode(e))}
                  </div>
                ` : E}
            ${t.length > 0 ? w`
                  <div class="group">
                    ${n ? w`<span class="group-title">${z(this.language, "dialog.swing.horizontal")}</span>` : E}
...
customElements.get("eq-swing-dialog") || customElements.define("eq-swing-dialog", dl);
//#endregion
  ...
  `;
	...
	_presetTone(e) {
		return Ks({
			...
			family: "preset",
			mode: e,
			defaultTone: Oc(e, this.viewModel?.climate.hvacMode)
		});
	}
	_dispatchClose() {
		this.dispatchEvent(new CustomEvent("eq-dialog-close", {
...
var hl = class extends D {
  ...
  `;
	...
	async _commitSingle() {
		!this.hass || !this.config || !this.viewModel || this._isDisabled() || await pc({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
...
var _l = 60, vl = [
  ...
  `;
	...
	async _startBoost() {
		...
		(this._hasTimedPreset() ? await yc(e, "boost", this._durationMinutes) : await hc(e, "boost")).ok && this._dispatchClose();
	}
	async _stopBoost() {
		!this.hass || !this.config || (await bc({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
...
var El = class extends D {
  ...
  `;
	...
	_betterHistoryConfig() {
		let e = this.config?.entity, t = (e ? this.hass?.states[e] : void 0)?.attributes.current_humidity !== void 0, n = t ? void 0 : this.config?.humidity_entity, r = this.language ?? this.hass?.locale?.language, i = this.config && this.hass ? Jc(this.hass, this.config) : void 0, a = `${e ?? ""}|${r ?? ""}|${i ?? ""}|${this.config?.power_entity ?? ""}|${n ?? ""}|${this.config?.temperature_entity ?? ""}|${t ? "climate-humidity" : "external-humidity"}`;
  ...
  `;
	...
	_renderMetric(e) {
      ...
      <div class="sensor-row">
        ...
        <div class="sensor-main">
          ...
          ${t ? w`<span class="sensor-updated">${t}</span>` : E}
        </div>
	...
	render() {
      ...
      >
        ...
        <div class="content">
          ${e.length > 0 ? w`<div class="sensor-summary">${e.map((e) => this._renderMetric(e))}</div>` : w`<div class="empty">${z(this._language(), "dialog.sensor_more_info.unavailable")}</div>`}
          ${e.length > 0 ? w`
...
var q = "--", zl = /* @__PURE__ */ new Set([
  ...
  `;
	...
	render() {
      ...
      <section class="section" aria-labelledby="regulation-section-title">
        <div class="section-header">
          ...
          ${this._sectionSummary(e) ? w`<p class="summary">${this._sectionSummary(e)}</p>` : E}
        </div>
	...
	_renderState(e) {
		return w`<div class="state" role="status">${e}</div>`;
	}
	_activeSection() {
	...
	_renderItem(e) {
		...
		switch (e.type) {
			case "hero_status": return w`
          <article class="hero" tone=${e.tone ?? "info"}>
            ${e.icon ? w`<ha-icon icon=${e.icon}></ha-icon>` : w`<ha-icon icon="mdi:information-outline"></ha-icon>`}
            <div class="hero-content">
              <h3>${this._translate(e.title_key, e.title)}</h3>
              ${this._translate(e.subtitle_key, e.subtitle) ? w`<p class="description">${this._translate(e.subtitle_key, e.subtitle)}</p>` : E}
            </div>
          </article>
        `;
			...
			case "text": return w`<article class="block"><p class="text">${this._translate(e.text_key, e.text)}</p></article>`;
			case "section_note": return w`
          <aside class="note" tone=${e.tone ?? "muted"}>
            ${e.icon ? w`<ha-icon icon=${e.icon}></ha-icon>` : w`<ha-icon icon="mdi:note-text-outline"></ha-icon>`}
        ...
        `;
			...
			case "layout_grid": {
				let t = this._translate(e.title_key, e.title), n = w`
          <div
            class="layout-grid"
        ...
        `;
				return t ? w`<section class="layout-section"><h3>${t}</h3>${n}</section>` : n;
			}
			default: return E;
		}
	}
	_renderValue(e) {
      ...
      <article class="block" tone=${this._toneForValue(e)}>
        ...
        ${t ? w`<p class="missing">${z(this.language, "dialog.regulation.source_missing")}</p>` : E}
      </article>
    `;
	}
	_renderMetricGrid(e) {
		let t = e.metrics.filter((e) => this._conditionMatches(e.visible_if));
		return t.length === 0 ? E : w`
      <article class="block">
        ${this._translate(e.title_key, e.title) ? w`<h3>${this._translate(e.title_key, e.title)}</h3>` : E}
	...
	_renderMetric(e) {
      ...
      <div class="metric" tone=${this._toneForValue(e)}>
        <span class="label">${this._translate(e.label_key, e.label)}</span>
        <span class="value">${this._formatSourceValue(e)}</span>
        ${this._sourceMissing(e.source) ? w`<span class="meta">${z(this.language, "dialog.regulation.source_missing")}</span>` : E}
      </div>
    `;
	}
	_renderStatus(e) {
	...
	_renderProgress(e) {
      ...
      <article class="block" tone="info">
        ...
        ${this._sourceMissing(e.value.source) ? w`<p class="missing">${z(this.language, "dialog.regulation.source_missing")}</p>` : E}
      </article>
    `;
	}
	_renderHistory(e) {
		let t = this._betterHistoryConfig(e), n = e.options ?? {}, r = this._showHistoryControls(n), i = n.tools === !0 || n.range_picker === !0;
		return !t.series || t.series.length === 0 ? w`
	...
	_renderAction(e) {
      ...
      <article class="block action-block" tone=${this._isDestructiveAction(e) ? "warning" : "info"}>
        ...
        ${r ? w`<p class="missing">${z(this.language, "dialog.regulation.action_locked")}</p>` : E}
        ${this._actionError === n ? w`<p class="missing" role="alert">${z(this.language, "dialog.regulation.action_failed")}</p>` : E}
      </article>
    `;
	}
	...
	_resolveActionValue(e) {
		...
		switch (e) {
			...
			case "$diagnostic_entity": return this.config && this.hass ? Jc(this.hass, this.config) : void 0;
	...
	_isDestructiveAction(e) {
		return zl.has(e.service);
	}
	_isThermostatLocked() {
		return this.viewModel?.vt?.lock.isUserLocked === !0 || Zc(this._context(), "climate", "lock_manager/is_locked") === !0;
	}
	_actionKey(e) {
	...
	_betterHistorySeries(e) {
		...
		return t ? [{
			entity: t,
			attribute: e.attribute ? Gc(e.attribute) : void 0,
	...
	_historyConfigCacheKey(e) {
		return JSON.stringify({
			...
			diagnostic: this.config && this.hass ? Jc(this.hass, this.config) ?? "" : "",
	...
	_toneForValue(e) {
		let t = Zc(this._context(), e.source, e.path);
		return e.tone_map?.[String(t)] ?? "muted";
	}
	_readValueRef(e) {
		return Zc(this._context(), e.source, e.path);
	}
	_asNumber(e) {
		if (typeof e == "number") return Number.isFinite(e) ? e : void 0;
		if (typeof e != "string" || e.trim() === "") return;
	...
	_sourceMissing(e) {
		return !this.hass || !this.config || Yc(this.hass, this.config)[e] === void 0;
	}
	_conditionMatches(e) {
	...
	_readConditionVariable(e) {
		...
		if (!(!n || ![
			...
			"temperature",
			"config"
		].includes(n))) return Zc(this._context(), n, t.slice(1));
	}
...
customElements.get("eq-regulation-renderer") || customElements.define("eq-regulation-renderer", Bl);
//#endregion
//#region src/components/eq-regulation-dialog.ts
var Vl = class extends D {
	constructor(...e) {
  ...
  `;
	...
	_renderContent() {
		...
		if (!this.hass || !this.config) return w`<div class="state" role="status">${z(this.language, "dialog.regulation.loading")}</div>`;
		if (this.loadResult?.status === "unavailable") return w`<div class="state" role="status">${z(this.language, "dialog.regulation.unavailable")}</div>`;
		if (this.loadResult?.status === "error") {
			...
			return w`<div class="state" role="alert">${z(this.language, e)}</div>`;
		}
		if (!this.dashboard || this.dashboard.kind !== "regulation-dashboard" || this.dashboard.sections.length === 0) return w`<div class="state" role="alert">${z(this.language, "dialog.regulation.invalid")}</div>`;
		let e = this._activeSectionId();
		return this._isMobile() && this.dashboard.sections.length > 1 ? this._renderMobileSectionSheet(e) : w`
      <div class="layout" ?single-section=${this.dashboard.sections.length === 1}>
        ${this.dashboard.sections.length > 1 ? w`
			...
			return w`
                    ...
                    >
                      ${t.icon ? w`<ha-icon icon=${t.icon}></ha-icon>` : E}
                      <span>${n}</span>
                    </button>
                  `;
		})}
...
customElements.get("eq-regulation-dialog") || customElements.define("eq-regulation-dialog", Vl);
//#endregion
...
var Hl = 4, Ul = [
	...
	constructor(...e) {
		super(...e), this.open = !1, this.entityId = "", this.isLocking = !0, this._code = "", this._error = !1, this._loading = !1, this._onKeyDown = (e) => {
			this.open && (e.key >= "0" && e.key <= "9" ? this._pressDigit(e.key) : e.key === "Backspace" ? this._pressBackspace() : e.key === "Escape" ? this._cancel() : e.key === "Enter" && this._code.length === Hl && this._validate());
		};
	}
	static {
		this.properties = {
  ...
  `;
	...
	render() {
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        <div class="error-msg">${this._error ? r : E}</div>
        <div class="keypad">
          ${Ul.map((e) => this._renderKey(e))}
        </div>
	...
	_renderKey(e) {
      ...
      <button
        class="key"
        ?disabled=${this._loading || this._code.length >= Hl}
	...
	_pressDigit(e) {
		this._loading || this._code.length >= Hl || (this._error = !1, this._code += e, this._code.length === Hl && this._validate());
	}
	_pressBackspace() {
		this._loading || this._code.length === 0 || (this._error = !1, this._code = this._code.slice(0, -1));
	}
	async _validate() {
		if (this._loading || !this.hass || this._code.length < Hl) return;
		this._loading = !0;
...
customElements.get("eq-lock-dialog") || customElements.define("eq-lock-dialog", Wl);
//#endregion
//#region src/components/eq-main-card.ts
var Gl = "equinox", Kl = /* @__PURE__ */ new Set(/* @__PURE__ */ "primary.accent.red.pink.purple.deep-purple.indigo.blue.light-blue.cyan.teal.green.light-green.lime.yellow.amber.orange.deep-orange.brown.light-grey.grey.dark-grey.blue-grey.black.white.primary-text.secondary-text.disabled".split(".")), ql = [
	{
		key: "hasOverpowering",
...
function eu(e, t) {
	...
	let n = Ql(e);
	if (n) return $l(n) > .42 ? "#111418" : "#ffffff";
}
function tu(e) {
	if (e == null || e === "") return;
	let t = Number(e);
...
var nu = class extends D {
	...
	_browserHistoryEntry(e = window.history.state) {
		let t = typeof e == "object" && e ? e[Gl] : void 0;
		if (typeof t != "object" || !t) return;
		let n = t;
	...
	_clearBrowserHistoryState() {
		...
		delete e[Gl], window.history.replaceState(e, "", window.location.href);
	}
	...
	_regulationLoadCacheKey() {
		if (!this.hass || !this.config) return;
		let e = tl(this.hass, this.config);
	...
	_ensureRegulationDashboard() {
		...
		let e = tl(this.hass, this.config), t = this._regulationLoadCacheKey();
		...
		let n = Ic(e).then((e) => (this._regulationLoadKey === t && (this._regulationLoadResult = e, this._regulationLoadPromise = void 0, e.status === "loaded" && !this._regulationActiveSectionId && (this._regulationActiveSectionId = e.dashboard.sections[0]?.id)), e));
	...
	render() {
      ...
      >
        <div class="card" ?thin=${t}>
          ${t ? this._renderThinLayout() : w`
                ${this._renderName()}
                ${n ? E : this._renderStatus()}
                <div class="layout" ?state-vertical=${n}>
                  ...
                  ${n ? w`<div class="left-rail">${this._renderLeftRail()}</div>` : E}
                  ${n ? w`<div class="state-rail">${this._renderStateRail()}</div>` : E}
                </div>
              `}
            </div>
      </ha-card>
	...
	_renderHistoryDialog() {
		return this._activeDialog === "history" ? w`
      <eq-history-dialog
        .open=${!0}
        .hass=${this.hass}
        .config=${this.config}
	...
	_renderSensorMoreInfoDialog() {
		return this._activeDialog !== "sensor-more-info" || !this._activeSensorInfoTarget ? E : w`
	...
	_renderRegulationDialog() {
		return this._activeDialog === "regulation" ? w`
	...
	_renderMessageDialog() {
		return this._activeMessageKey === void 0 ? E : w`
      <eq-dialog
        .open=${!0}
	...
	_cardStyle() {
		let e = Zl(this.config?.card_background_color), t = tu(this.config?.card_background_opacity), n = eu(this.config?.card_background_color, t), r = e && t !== void 0 ? `color-mix(in srgb, ${e} ${t}%, transparent)` : e || (t === void 0 ? void 0 : `color-mix(in srgb, var(--equinox-card-bg) ${t}%, transparent)`), i = [];
      ...
      <div class="thin-summary">
        <div class="thin-readings" ?has-humidity=${t}>
          <span
            class="thin-current"
            ?clickable=${n}
            @click=${n ? (e) => this._openTemperatureInfo(e) : E}
          >
	...
	_renderThinTemperatureValue() {
      ...
      `;
		...
		return w`<span class="thin-temperature-value" tone=${this._targetTone()}>${this._formatTargetTempSummary()}</span>`;
	}
	_renderThinPrimarySelectors() {
		let e = this._renderThinHvacButton(), t = this._renderThinPresetButton();
		return e === E && t === E ? E : w`<div class="thin-selectors thin-primary-selectors">${e}${t}</div>`;
	}
	_renderThinExtraSelectors() {
		let e = this._shouldShowAutoStartStopControl() ? this._renderThinAutoStartStopButton() : E, t = this._shouldShowFanControl() ? this._renderThinFanButton() : E, n = this._shouldShowSwingControl() ? this._renderThinSwingButton() : E;
		return e === E && t === E && n === E ? E : w`<div class="thin-selectors thin-extra-selectors">${e}${t}${n}</div>`;
	}
	_thinExtraSelectorCount() {
		return +!!this._shouldShowAutoStartStopControl() + +!!this._shouldShowFanControl() + +!!this._shouldShowSwingControl();
	}
	...
	_renderStatus() {
		...
		return w`
      <div class="status">
        ${this._shouldShowAutoStartStopControl() ? this._renderAutoStartStopButton() : E}
	...
	_renderHvacStateIcon() {
		...
		if (t === "off" && this.viewModel?.vt?.messages.some((e) => e.key === "hvac_off_manual")) return E;
	...
	_hvacActionIcon(e, t) {
		...
		let r = e ? Yl[e] : void 0, i = r?.icon || (t ? this._hvacIcon(t) : "");
		return i ? {
			icon: i,
	...
	_renderEvents() {
		...
		if (!e) return [];
		let n = new Set(ql.filter((e) => e.key === "hasTimer").flatMap((e) => e.messageKeys ?? [])), r = t.map((e) => {
	...
	_renderPowerInfoButton() {
      ...
      <button
        ...
        ?has-gauge=${!!e}
        ?show-value=${!!o}
        tone=${e ? this._powerGaugeTone(e.value) : E}
        title=${r}
        aria-label=${i}
      ...
      >
        ${e ? w`
              <span class="power-gauge" aria-hidden="true">
                ...
                ${o ? w`<span class="power-gauge-value">${e.label}</span>` : E}
              </span>
            ` : w`<ha-icon .icon=${this._powerInfoButtonIcon()}></ha-icon>`}
      </button>
    `;
	}
	...
	_renderAutoStartStopButton() {
		let e = this._autoStartStopLabel();
		return w`
      <button
      ...
      >
        <ha-icon icon="mdi:power-cycle"></ha-icon>
        <span class="auto-start-stop-label">${e}</span>
      </button>
    `;
	}
	_shouldShowAutoStartStopControl() {
		return this.viewModel?.vt?.autoStartStop.isConfigured === !0;
	}
	_autoStartStopTone() {
		return this.viewModel?.vt?.autoStartStop.isEnabled ? "boost" : "off";
	}
	_autoStartStopLabel() {
		let e = this.viewModel?.vt?.autoStartStop, t = e?.isEnabled ? e.stopMode ?? "off" : "disabled";
		return z(this._language(), `dialog.auto_start_stop.mode.${t}`);
	}
	_renderSwingButton() {
	...
	_shouldShowFanControl() {
		let e = this.viewModel?.vt?.fan.kind === "plugin";
		return this.config?.show_fan_mode !== !1 && this._hasFanControl() && (e || this._visibleFanModes().length > 0);
	}
	_hasSwingControl() {
	...
	_presetTone(e) {
		return this.viewModel?.climate.availability === "available" ? Ks({
			config: this.config,
			family: "preset",
			mode: e,
			defaultTone: Oc(e, this.viewModel?.climate.hvacMode)
	...
	_visibleFanModes() {
		let e = this.viewModel?.vt?.fan.kind === "legacy" ? js : this.viewModel?.climate.fanModes ?? [];
		return V({
			config: this.config,
			family: "fan",
			modes: e,
	...
	_activeFanDisplayMode() {
		return this.viewModel?.vt?.fan.kind === "plugin" ? this.viewModel.vt.fan.selectedFanMode : this.viewModel?.vt?.fan.kind === "legacy" && this.viewModel.vt.fan.currentAutoFanMode ? this.viewModel.vt.fan.currentAutoFanMode : this.viewModel?.climate.fanMode ?? (this.viewModel?.climate.fanModes.includes("auto") ? "auto" : void 0);
	}
	_fanIcon() {
		if (this.viewModel?.vt?.fan.kind === "plugin") return this.viewModel.vt.fan.isEnabled ? "mdi:fan-auto" : "mdi:fan-off";
	...
	_fanLabel() {
		let e = this._activeFanDisplayMode();
		return this.viewModel?.vt?.fan.kind === "plugin" ? e ?? z(this._language(), this.viewModel.vt.fan.isEnabled ? "main.fan.plugin_enabled" : "main.fan.plugin_disabled") : e ? Gs({
			config: this.config,
			language: this._language(),
			family: "fan",
			mode: e
	...
	_setHvacMode(e) {
		!this.hass || !this.config || !this.viewModel || mc({
			hass: this.hass,
			entityId: this.config.entity,
			viewModel: this.viewModel
		}, e);
...
customElements.get("eq-main-card") || customElements.define("eq-main-card", nu);
//#endregion
//#region src/data/format.ts
var ru = /* @__PURE__ */ new Set(["unknown", "unavailable"]);
function iu(e) {
	return e == null || typeof e == "string" && ru.has(e);
}
function Y(e) {
	if (!(iu(e) || typeof e != "string" || e.trim() === "")) return e;
}
function X(e) {
	if (iu(e)) return;
	if (typeof e == "number") return Number.isFinite(e) ? e : void 0;
...
function lu(e) {
	return {
		isPresenceConfigured: ou(e.is_presence_configured),
		isPowerConfigured: ou(e.is_power_configured),
		isMotionConfigured: ou(e.is_motion_configured),
		isWindowConfigured: ou(e.is_window_configured),
		isWindowAutoConfigured: ou(e.is_window_auto_configured),
		isSafetyConfigured: ou(e.is_safety_configured),
		isLockConfigured: ou(e.is_lock_configured),
		isHeatingFailureDetectionConfigured: ou(e.is_heating_failure_detection_configured),
		isRepairIncorrectStateConfigured: ou(e.is_repair_incorrect_state_configured)
	};
}
function uu(e) {
...
function pu(e, t, n) {
	let r = su($(e, ["specific_states", "messages"]));
	return n && du.has(n) && r.push(n), $(e, ["safety_manager", "safety_state"]) === "on" && r.push("safety_detected"), $(e, ["heating_failure_detection_manager", "heating_failure_state"]) === "on" && r.push("heating_failure"), $(e, ["heating_failure_detection_manager", "cooling_failure_state"]) === "on" && r.push("cooling_failure"), $(e, ["power_manager", "overpowering_state"]) === "on" && r.push("overpowering_detected"), hu(e, t) && r.push("smartpi_calibration"), [...new Set(r)].map((e) => ({
		key: e,
		severity: cu(e)
	}));
}
...
function _u(e, t, n) {
	let r = n.attributes, i = Q(r.specific_states), a = uu(r);
	if (!(a.length > 0 || i !== void 0 || Q(r.configuration) !== void 0)) return;
	let o = lu(r), s = Z(X($(r, ["vtherm_over_switch", "power_percent"])), X($(r, [
		"vtherm_over_climate",
		"valve_regulation",
		"power_percent"
		...
		"valve_regulation",
		"valve_open_percent"
	])), X(r.valve_open_percent)), l = $(r, ["timed_preset_manager", "is_active"]) === !0, u = Z($(r, ["lock_manager", "is_locked"]) === !0 || void 0, $(r, ["specific_states", "is_locked"]) === !0 || void 0) === !0, d = Z(Y($(r, ["specific_states", "hvac_mode_reason"])), Y($(r, ["specific_states", "hvac_off_reason"]))), f = pu(r, t, d), p = Y($(r, ["vtherm_over_climate", "auto_fan_mode"])), m = Y($(r, ["vtherm_over_climate", "current_auto_fan_mode"])), h = Array.isArray(r.auto_fan) ? void 0 : Q(r.auto_fan), g = h ? "plugin" : p !== void 0 || m !== void 0 ? "legacy" : "none", _ = e.auto_fan_enable_entity ? t.states[e.auto_fan_enable_entity] : void 0, v = gu(_, "switch"), y = Q(r.auto_start_stop_manager), b = e.auto_start_stop_enable_entity ? t.states[e.auto_start_stop_enable_entity] : void 0, ee = e.auto_start_stop_stop_mode_entity ? t.states[e.auto_start_stop_stop_mode_entity] : void 0, te = au(ee?.attributes.options).filter((e) => fu.has(e)), x = e.power_entity ? t.states[e.power_entity] : void 0, ne = Y($(r, ["requested_state", "hvac_mode"]));
	return {
		isVt: !0,
		types: a,
		configuration: {
			type: Y($(r, ["configuration", "type"])),
			proportionalFunction: mu(r),
		...
		powerValve: {
			...
			instantPower: X(x?.state),
			instantPowerUnit: Y(x?.attributes.unit_of_measurement)
		},
		timedPreset: {
			isActive: l,
		...
		events: {
			isHeating: r.hvac_action === "heating" || a.includes("over_switch") && s !== void 0 && s > 0 && ne === "heat",
			...
			hasLock: u,
			hasAlert: f.some((e) => e.severity === "alert"),
			hasDanger: f.some((e) => e.severity === "danger")
		},
		messages: f,
		fan: {
			kind: g,
			autoFanMode: p,
			currentAutoFanMode: m,
			isEnabled: g === "plugin" ? v ? _?.state === "on" : h?.enabled === !0 : m !== void 0 && m !== "auto_fan_none",
			selectedFanMode: Y(h?.selected_fan_mode),
			pluginSwitchAvailable: g === "plugin" && v,
			hasAutoFan: g !== "none"
		},
		autoStartStop: {
			isConfigured: r.is_auto_start_stop_configured === !0,
			isEnabled: y?.auto_start_stop_enable === !0,
			stopMode: Y(y?.auto_start_stop_stop_mode),
			stopModeOptions: te,
			hvacModeReason: d,
			enableEntityAvailable: gu(b, "switch"),
			stopModeEntityAvailable: gu(ee, "select")
		},
		specificStates: i,
...
function wu(e, t, n) {
	let r = n.attributes, i = Su(e, t), a = Z(iu(n.state) ? void 0 : n.state, Y(r.hvac_mode), Y(yu(r, ["current_state", "hvac_mode"]))), o = Z(Y(r.preset_mode), Y(yu(r, ["current_state", "preset"]))), s = a === "cool" && o === "frost" ? "none" : o;
	return {
		...
		targetTemperature: Z(X(r.temperature), X(yu(r, ["current_state", "target_temperature"]))),
		currentTemperature: i?.value ?? X(r.current_temperature),
		currentTemperatureDecimals: i?.decimals,
		temperatureEntityId: i?.entityId,
		currentHumidity: xu(e, t, r),
		hvacModes: au(r.hvac_modes),
		presetModes: au(r.preset_modes),
		presetMode: s,
		fanMode: Y(r.fan_mode),
		fanModes: au(r.fan_modes),
		swingMode: Y(r.swing_mode),
		swingModes: au(r.swing_modes),
		swingHorizontalMode: Y(r.swing_horizontal_mode),
		swingHorizontalModes: au(r.swing_horizontal_modes),
		minTemp: X(r.min_temp),
		maxTemp: X(r.max_temp),
		targetTempStep: Z(X(r.target_temp_step), X(yu(r, ["configuration", "target_temperature_step"])), .5),
...
function ku(e) {
	...
	let t = [...new Set(e.filter(Eu).map((e) => e.trim()).filter((e) => e.length > 0))];
...
function Nu(e) {
	...
	if (delete t.card_height, !Eu(t.entity) || t.entity.trim() === "") return {
		config: t,
		error: "missing_entity"
	};
	if (t.entity = t.entity.trim(), !Ou(t.entity)) return {
		config: t,
		error: "invalid_entity"
	};
	if (!Du($s, t.theme)) return {
		config: t,
		error: "invalid_theme"
	};
	if (!Du(ec, t.display_mode)) return {
		config: t,
		error: "invalid_display_mode"
	};
	if (!Du(tc, t.primary_display)) return {
		config: t,
		error: "invalid_primary_display"
	};
	if (t.setpoint_selector === void 0 && typeof t.use_temperature_popup == "boolean" && (t.setpoint_selector = t.use_temperature_popup ? "slider" : "buttons"), delete t.use_temperature_popup, !Du(nc, t.setpoint_selector)) return {
		config: t,
		error: "invalid_setpoint_selector"
	};
	if (!Du(rc, t.additional_dashboards)) return {
		config: t,
		error: "invalid_additional_dashboards"
	};
	if (!Du(ic, t.state_icons_layout)) return {
		config: t,
		error: "invalid_state_icons_layout"
	};
	let n = ju(t.card_background_color);
	n ? t.card_background_color = n : delete t.card_background_color;
	let r = Mu(t.card_background_opacity);
	r === void 0 ? delete t.card_background_opacity : t.card_background_opacity = r;
	let i = ku(t.hidden_hvac_modes), a = ku(t.hidden_preset_modes);
	i ? t.hidden_hvac_modes = i : delete t.hidden_hvac_modes, a ? t.hidden_preset_modes = a : delete t.hidden_preset_modes;
	let o = qs(t.mode_customizations);
...
function Fu(e) {
	return Pu[e.toLowerCase().split("-")[0] || "en"] ?? Pu.en;
}
function Iu(e, t) {
...
var Lu = class extends D {
  ...
  `;
	...
	render() {
		...
		return this.hass && !n ? this._renderMessage(z(e, "card.entity_not_found", { entity: t }), !0) : w`
      <eq-main-card
        .hass=${this.hass}
...
customElements.get("equinox-card") || customElements.define(hs, Lu), window.customCards = window.customCards ?? [];
var Ru = window.customCards;
Ru.filter((e) => e.type === "equinox-card" || e.type === "custom:equinox-card" || e.name === "Equinox").forEach((e) => {
	Ru.splice(Ru.indexOf(e), 1);
}), Ru.push({
	type: hs,
	name: ps,
	description: Fu(navigator.language),
	preview: !0,
	documentationURL: "https://github.com/KipK/equinox#readme",
	getEntitySuggestion: Iu
});
//#endregion
export { Lu as EquinoxCard };
